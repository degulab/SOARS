...
public class ResourceManager extends ResourceManagerBase {
	 ...
	 * 
	 */
	static private String _filePath = "../resource/properties/application/visualshell4/common/utility/tool/ssh/filechooser/Resource_%s.properties";

	/**
	 * 
	 */
	static private String _defaultFilePath = "../resource/properties/application/visualshell4/common/utility/tool/ssh/filechooser/Resource.properties";
