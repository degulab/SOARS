 ...
 *
 */
public class FileEditorDlg extends Dialog implements IFileMenuHandler, IEditMenuHandler, ITextUndoRedoManagerCallBack {
...
//	private JButton _fileSaveAsButton = null;
	 ...
	 */
	public FileEditorDlg(Frame arg0, String arg1, boolean arg2, Image image, File file, EnvironmentBase environmentBase, String windowRectangleKey, String encoding, IFileManager fileManager, IFileManagerCallBack fileManagerCallBack) throws HeadlessException {
		super(arg0, ( null == encoding || encoding.equals( "")) ? arg1 : ( arg1 + " [" + encoding + "]"), arg2);
		_image = image;
		_file = file;
...
//		_fileSaveAsButton.setPreferredSize( new Dimension( imageIcon.getIconWidth() + 8, _fileSaveAsButton.getPreferredSize().height));
	...
	public void on_file_save_with_specified_encoding(ActionEvent actionEvent) {
		EncodingSelectorDlg encodingSelectorDlg = new EncodingSelectorDlg( ( Frame)getOwner(), ResourceManager.get_instance().get( "encoding.selector.dialog.title"), true, _encoding);
