...
public class TextField extends JTextField {
	 ...
	 * @return
	 */
	public static TextField create(int width, Color color, boolean right, TabbedPage tabbedPage) {
		TextField textField = new TextField();
		textField.setPreferredSize( new Dimension( width, textField.getPreferredSize().height));
		textField.setup( color, right, tabbedPage);
		return textField;
	}
	 ...
	 * @return
	 */
	public static TextField create(TextLimiter textLimiter, int width, Color color, boolean right, TabbedPage tabbedPage) {
		TextField textField = new TextField();
	 ...
	 * @return
	 */
	public static TextField create(TextLimiter textLimiter, String text, int width, Color color, boolean right, TabbedPage tabbedPage) {
		TextField textField = new TextField();
		textField.setDocument( textLimiter);
	 ...
	 * @return
	 */
	public static TextField create(TextExcluder textExcluder, int width, Color color, boolean right, TabbedPage tabbedPage) {
		TextField textField = new TextField();
	 ...
	 * @return
	 */
	public static TextField create(TextExcluder textExcluder, String text, int width, Color color, boolean right, TabbedPage tabbedPage) {
		TextField textField = new TextField();
		textField.setDocument( textExcluder);
		textField.setText( text);
		textField.setPreferredSize( new Dimension( width, textField.getPreferredSize().height));
	 ...
	 * @param tabbedPage
	 */
	private void setup(Color color, boolean right, TabbedPage tabbedPage) {
		setup( color, right);
