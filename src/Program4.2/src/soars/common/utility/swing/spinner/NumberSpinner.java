...
public class NumberSpinner extends JSpinner {
	 ...
	 * @param tabbedPage
	 */
	public NumberSpinner(TabbedPage tabbedPage) {
		super();
		SpinnerNumberModel spinnerNumberModel = new SpinnerNumberModel( 1, 1, 1, 1);
		setModel( spinnerNumberModel);
		setup( tabbedPage);
	 ...
	 * @param tabbedPage
	 */
	public NumberSpinner(Color color, TabbedPage tabbedPage) {
		super();
		_color = color;
		SpinnerNumberModel spinnerNumberModel = new SpinnerNumberModel( 1, 1, 1, 1);
		setModel( spinnerNumberModel);
	 ...
	 * @param tabbedPage
	 */
	public NumberSpinner(SpinnerNumberModel arg0, TabbedPage tabbedPage) {
		super(arg0);
		setup( tabbedPage);
	}
	 ...
	 * @param tabbedPage
	 */
	public NumberSpinner(SpinnerNumberModel arg0, Color color, TabbedPage tabbedPage) {
		super(arg0);
		_color = color;
		setup( tabbedPage);
	}
	 ...
	 * @param tabbedPage
	 */
	public NumberSpinner(INumberSpinnerHandler numberSpinnerHandler, TabbedPage tabbedPage) {
		super();
		_numberSpinnerHandler = numberSpinnerHandler;
		SpinnerNumberModel spinnerNumberModel = new SpinnerNumberModel( 1, 1, 1, 1);
		setModel( spinnerNumberModel);
	 ...
	 * @param tabbedPage
	 */
	public NumberSpinner(Color color, INumberSpinnerHandler numberSpinnerHandler, TabbedPage tabbedPage) {
		super();
		_color = color;
		_numberSpinnerHandler = numberSpinnerHandler;
		SpinnerNumberModel spinnerNumberModel = new SpinnerNumberModel( 1, 1, 1, 1);
	 ...
	 * @param tabbedPage
	 */
	public NumberSpinner(SpinnerNumberModel arg0, INumberSpinnerHandler numberSpinnerHandler, TabbedPage tabbedPage) {
		super(arg0);
		_numberSpinnerHandler = numberSpinnerHandler;
		setup( tabbedPage);
	}
	 ...
	 * @param tabbedPage
	 */
	public NumberSpinner(SpinnerNumberModel arg0, Color color, INumberSpinnerHandler numberSpinnerHandler, TabbedPage tabbedPage) {
		super(arg0);
		_numberSpinnerHandler = numberSpinnerHandler;
		_color = color;
		setup( tabbedPage);
	 ...
	 * @param tabbedPage
	 */
	private void setup(TabbedPage tabbedPage) {
		setup();
	...
	public void set_value(int value) {
		SpinnerNumberModel spinnerNumberModel = ( SpinnerNumberModel)getModel();
		spinnerNumberModel.setValue( Integer.valueOf( value));
	}
	...
	public void set_maximum(int maximum) {
		SpinnerNumberModel spinnerNumberModel = ( SpinnerNumberModel)getModel();
		spinnerNumberModel.setMaximum( Integer.valueOf( maximum));
	...
	public void set_minimum(int minimum) {
		SpinnerNumberModel spinnerNumberModel = ( SpinnerNumberModel)getModel();
		spinnerNumberModel.setMinimum( Integer.valueOf( minimum));
	}
}
