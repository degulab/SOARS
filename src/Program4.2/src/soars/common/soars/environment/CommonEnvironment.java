...
public class CommonEnvironment extends EnvironmentBase {
	 ...
	 * 
	 */
	static public final String _showAdvancedMenusKey = "Show.advanced.menus";
	...
	public String get_memory_size() {
		return get( get_memory_size_key(), CommonConstant._defaultMemorySize);
	}
