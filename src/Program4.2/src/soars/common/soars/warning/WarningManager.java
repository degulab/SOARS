 ...
 * @author kurata
 */
public class WarningManager extends Vector {
	 ...
	 * @return
	 */
	public Vector get(String separator) {
		Vector messages = new Vector();
		for ( int i = 0; i < size(); ++i) {
			String[] words = ( String[])get( i);
			String message = "";
	 ...
	 * @return
	 */
	private String get(Vector messages) {
		String string = "";
