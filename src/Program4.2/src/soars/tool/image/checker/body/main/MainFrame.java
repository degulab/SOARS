...
public class MainFrame extends Frame implements IMacScreenMenuHandler {
	...
	private void setup_menu() {
		...
		InitializeListAction initializeListAction = new InitializeListAction( ResourceManager.get( "file.initialize.list.menu"));
		_file_initialize_list_menuItem = _userInterface.append_menuitem(
			menu,
			ResourceManager.get( "file.initialize.list.menu"),
			initializeListAction,
			ResourceManager.get( "file.initialize.list.mnemonic"),
			ResourceManager.get( "file.initialize.list.stroke"),
			_message_label,
			ResourceManager.get( "file.initialize.list.message"));


		CopyToClipboardAction copyToClipboardAction = new CopyToClipboardAction( ResourceManager.get( "file.copy.to.clipboard.menu"));
		_file_copy_to_clipboard_menuItem = _userInterface.append_menuitem(
			menu,
			ResourceManager.get( "file.copy.to.clipboard.menu"),
			copyToClipboardAction,
			ResourceManager.get( "file.copy.to.clipboard.mnemonic"),
			ResourceManager.get( "file.copy.to.clipboard.stroke"),
			_message_label,
			ResourceManager.get( "file.copy.to.clipboard.message"));
