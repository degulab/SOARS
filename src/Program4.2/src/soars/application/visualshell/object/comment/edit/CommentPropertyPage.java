 ...
 */
public class CommentPropertyPage extends TabbedPage implements ITextUndoRedoManagerCallBack {
...
//		setup_export_checkBox( southPanel);
	...
	private void setup_commentTextArea(JPanel parent) {
		...
		text_area_panel.setLayout( new GridLayout( 1, 1));
		...
		text_area_panel.add( _scrollPane);
...
//
//		_export_checkBox = new JCheckBox(
//			ResourceManager.get_instance().get( "edit.comment.dialog.export"));
//		_export_checkBox.setSelected( CommentManager.get_instance()._export);
//
//		panel.add( _export_checkBox);
//		parent.add( panel);
//	}
