 ...
 *
 */
public class ExpressionPropertyPage extends TabbedPage {
	...
	protected boolean on_create() {
		...
		if ( !setup_expression_table( centerPanel))
			return false;
	 ...
	 * 
	 */
	private void create_expression_table() {
		_expressionTable = new ExpressionTable( _owner, this);
	}
	 ...
	 * @return
	 */
	private boolean setup_expression_table(JPanel parent) {
