 ...
 *
 */
public class PropertyPageBase extends TabbedPage implements ITextUndoRedoManagerCallBack {
	 ...
	 * @param parent
	 */
	public PropertyPageBase(String title, PlayerBase playerBase, Map<String, PropertyPageBase> propertyPageMap, int index, Frame owner, Component parent) {
		super();
		_title = title;
