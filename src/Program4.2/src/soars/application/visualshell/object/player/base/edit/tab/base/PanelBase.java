...
public class PanelBase extends JPanel implements ITextUndoRedoManagerCallBack {
	 ...
	 * @param parent
	 */
	public PanelBase(String kind, PlayerBase playerBase, Map<String, PropertyPageBase> propertyPageMap, VariableTableBase variableTableBase, Color color, Frame owner, Component parent) {
		super();
		_kind = kind;
