 ...
 *
 */
public class UnitPanel extends ExchangeAlgebraInitialValueTextPanelBase {
	 ...
	 * @param playerBase 
	 */
	public UnitPanel(Color color, PlayerBase playerBase, Map<String, PropertyPageBase> propertyPageMap) {
	...
	protected JLabel create_label() {
		return new JLabel( ResourceManager.get_instance().get( "edit.exchange.algebra.value.dialog.edit.unit"));
	}
}
