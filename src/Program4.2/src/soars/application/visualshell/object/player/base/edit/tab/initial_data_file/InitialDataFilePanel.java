...
public class InitialDataFilePanel extends PanelBase {
	 ...
	 * @param parent
	 */
	public InitialDataFilePanel(PlayerBase playerBase, Map<String, PropertyPageBase> propertyPageMap, VariableTableBase variableTableBase, FileManager fileManager, Color color, Frame owner, Component parent) {
		super("initial data file", playerBase, propertyPageMap, variableTableBase, color, owner, parent);
	...
	private void setup_initialValueTextField(JPanel parent) {
		...
		_fileTextField = !_playerBase.is_multi() ? new FileDDTextField() : new JTextField();
...
//			return false;
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.player.base.edit.tab.base.PanelBase#confirm(int, soars.application.visualshell.object.player.base.object.base.ObjectBase, soars.application.visualshell.object.player.base.object.base.ObjectBase)
	 */
