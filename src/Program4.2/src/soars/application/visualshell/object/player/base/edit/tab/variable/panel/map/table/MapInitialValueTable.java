 ...
 * 
 */
package soars.application.visualshell.object.player.base.edit.tab.variable.panel.map.table;
...
public class MapInitialValueTable extends InitialValueTable {
	 ...
	 * @param parent
	 */
	public MapInitialValueTable(Color color, PlayerBase playerBase, Map<String, PropertyPageBase> propertyPageMap, VariablePanelBase variablePanelBase, Frame owner, Component parent) {
		super("map", color, playerBase, propertyPageMap, variablePanelBase, owner, parent);
	}
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.player.base.edit.tab.variable.panel.base.panel.table.InitialValueTable#append(java.lang.Object[])
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.player.base.edit.tab.variable.panel.base.panel.table.InitialValueTable#insert(java.lang.Object[])
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.player.base.edit.tab.variable.panel.base.panel.table.InitialValueTable#update(java.lang.Object[])
	 */
	...
	public boolean update_object_name(String type, String name, String new_name) {
		...
		for ( int i = 0; i < getRowCount(); ++i) {
			MapInitialValue mapInitialValue = ( MapInitialValue)getValueAt( i, 0);
			if ( mapInitialValue.update_object_name( type, name, new_name))
				result = true;
		}
		return result;
	}
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.player.base.edit.tab.variable.panel.base.panel.table.InitialValueTableBase#paste(int[])
	 */
	public void paste(int[] rows) {
		...
		for ( int i = 0; i < __initialValueBasesMap.get( _kind).size(); ++i) {
			...
			if ( !mapInitialValue.can_paste( _propertyPageMap, null, null, _playerBase)) {
				String key = ( mapInitialValue._key[ 0].equals( "immediate")
					? ( "\"" + mapInitialValue._key[ 1] + "\"")
					: ( PropertyPageBase._nameMap.get( mapInitialValue._key[ 0]) + ", name = " + mapInitialValue._key[ 1]));
				String[] message = new String[] {
					"key : " + key,
					"value : " + PropertyPageBase._nameMap.get( mapInitialValue._value[ 0]) + ", name = " + mapInitialValue._value[ 1]
				};
