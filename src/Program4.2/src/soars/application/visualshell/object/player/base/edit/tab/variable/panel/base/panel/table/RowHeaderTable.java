...
public class RowHeaderTable extends InitialValueTableBase {
	 ...
	 * @param parent
	 */
	public RowHeaderTable(Color color, PlayerBase playerBase, VariablePanelBase variablePanelBase, Frame owner, Component parent) {
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.player.base.edit.tab.variable.panel.base.panel.table.InitialValueTableBase#select(int[])
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.player.base.edit.tab.base.InitialValueTableBase#on_remove(java.awt.event.ActionEvent)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.player.base.edit.tab.base.InitialValueTableBase#append()
	 */
	public void append() {
		DefaultTableModel defaultTableModel = ( DefaultTableModel)getModel();
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.player.base.edit.tab.base.InitialValueTableBase#insert(int)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.player.base.edit.tab.base.InitialValueTableBase#up()
	 */
	public void up() {
		int[] rows = getSelectedRows();
		if ( 1 > rows.length)
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.player.base.edit.tab.base.InitialValueTableBase#down()
	 */
	public void down() {
		int[] rows = getSelectedRows();
		if ( 1 > rows.length)
