 ...
 * 
 */
package soars.application.visualshell.object.player.base.object.class_variable;
...
public class ClassVariableObject extends ObjectBase {
	...
	public boolean can_paste(PlayerBase playerBase, Layer drawObjects) {
		...
		if ( drawObjects.other_uses_this_class_variable_as_different_class( _name, _jarFilename, _classname, playerBase))
			return false;
	...
	public String get_initial_data() {
		String jar_filename = get_initial_data_jar_filename( _jarFilename);
		if ( null == jar_filename || jar_filename.equals( ""))
			return "";

		return ( ResourceManager.get_instance().get( "initial.data.class.variable")
			+ "\t" + _name + "\t" + jar_filename + "\t" + _classname + Constant._lineSeparator);
	}
	...
	public void write(Writer writer) throws SAXException {
		...
		//attributesImpl.addAttribute( null, null, "jar_filename", "", Writer.escapeAttributeCharData( _jarFilename));
