 ...
 * @author kurata
 */
public class ExTransferPropertyPage extends PropertyPageBase implements IFileManagerCallBack {
	 ...
	 * @param parent
	 */
	public ExTransferPropertyPage(String title, PlayerBase playerBase, Map<String, PropertyPageBase> propertyPageMap, int index, Frame owner, Component parent) {
	...
	protected void set_property_to_environment_file() {
		Environment.get_instance().set(
			Environment._editObjectDialogExTransferPropertyPageDividerLocationKey, String.valueOf( _splitPane.getDividerLocation()));
		Environment.get_instance().set(
	...
	protected boolean on_create() {
		...
		_splitPane.setDividerLocation( Integer.parseInt( Environment.get_instance().get( Environment._editObjectDialogExTransferPropertyPageDividerLocationKey, "250")));
	...
	private void create_fileTable() {
		_exTransferTable = new ExTransferTable( _playerBase, _propertyPageMap, this, _owner, _parent);
	}
	...
	private boolean setup_components(JPanel parent) {
		_exTransferPanel = new ExTransferPanel( _playerBase, _propertyPageMap, _exTransferTable, _fileManager, SystemColor.textText, _owner, _parent);
