 ...
 * 
 */
package soars.application.visualshell.object.player.base.edit.tab.variable.panel.set_and_list.set;
 ...
 *
 */
public class SetPanel extends VariablePanel {
	 ...
	 * @param parent
	 */
	public SetPanel(PlayerBase playerBase, Map<String, PropertyPageBase> propertyPageMap, VariableTable variableTable, Color color, Frame owner, Component parent) {
		super("collection", playerBase, propertyPageMap, variableTable, color, owner, parent);
	}
