...
import soars.application.visualshell.object.player.base.edit.tab.variable.panel.map.initial.panel.value.AgentSelectorPanel;
import soars.application.visualshell.object.player.base.edit.tab.variable.panel.map.initial.panel.value.ObjectSelectorPanel;
import soars.application.visualshell.object.player.base.edit.tab.variable.panel.map.initial.panel.value.SpotSelectorPanel;
...
public class MapInitialValueValuePanel extends JPanel {
	 ...
	 */
	public MapInitialValueValuePanel(Color color, PlayerBase playerBase, Map<String, PropertyPageBase> propertyPageMap) {
		super();
		_color = color;
	...
	private void setup_left_panel(JPanel parent) {
		...
		_typeComboBox.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if ( flag)
					_objectSelectorPanel.update( item, _playerBase, _propertyPageMap);
				revalidate();
				repaint();
			}
		});
