...
public class ExchangeAlgebraInitialValueButtonPanel extends JPanel {
	...
	/**
	 * @param value_textField
	 * @param base_type_comboBox
	 * @param keywordPanel
	 * @param namePanel
	 * @param hatPanel
	 * @param unitPanel
	 ...
	 */
	public ExchangeAlgebraInitialValueButtonPanel(TextField value_textField, ComboBox base_type_comboBox, KeywordPanel keywordPanel, NamePanel namePanel, HatPanel hatPanel, UnitPanel unitPanel, TimePanel timePanel, SubjectPanel subjectPanel, ExchangeAlgebraInitialValueTable exchangeAlgebraInitialValueTable) {
		super();
		_valueTextField = value_textField;
		_baseTypeComboBox = base_type_comboBox;
