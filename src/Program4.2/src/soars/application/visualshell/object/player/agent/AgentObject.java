 ...
 * 2005/04/20
 */
package soars.application.visualshell.object.player.agent;
 ...
 * @author kurata
 */
public class AgentObject extends PlayerBase {
	 ...
	 * @param graphics2D
	 */
	public AgentObject(int id, String name, Point position, String number, String initialRole, String initialSpot, String imageFilename, String gis, String[] gisCoordinates, Graphics2D graphics2D) {
		super(id, name, position, number, initialRole, imageFilename, gis, gisCoordinates, graphics2D);
	...
	/* (Non Javadoc)
	 * @see soars.application.visualshell.object.player.base.PlayerBase#on_get_script()
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.visualshell.object.player.base.PlayerBase#on_write(org.xml.sax.helpers.AttributesImpl)
	 */
