 ...
 * 2005/04/20
 */
package soars.application.visualshell.object.player.spot;
 ...
 * @author kurata
 */
public class SpotObject extends PlayerBase {
	 ...
	 * @param graphics2D
	 */
	public SpotObject(int id, String name, Point position, String number, String initialRole, String imageFilename, String gis, String[] gisCoordinates, Graphics2D graphics2D) {
