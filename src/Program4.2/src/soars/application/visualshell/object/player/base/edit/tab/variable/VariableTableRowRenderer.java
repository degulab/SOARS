...
public class VariableTableRowRenderer extends JLabel implements TableCellRenderer {
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
		...
		if ( null != value && value instanceof ObjectBase) {
			...
			if ( value instanceof VariableObject && objectBase._kind.equals( "collection")) {
				setForeground( isSelected ? Color.white : VariablePropertyPage._colorMap.get( ResourceManager.get_instance().get( "edit.object.dialog.tree.collection")));
				setBackground( isSelected ? VariablePropertyPage._colorMap.get( ResourceManager.get_instance().get( "edit.object.dialog.tree.collection")) : table.getBackground());
			} else if ( value instanceof VariableObject && objectBase._kind.equals( "list")) {
				setForeground( isSelected ? Color.white : VariablePropertyPage._colorMap.get( ResourceManager.get_instance().get( "edit.object.dialog.tree.list")));
				setBackground( isSelected ? VariablePropertyPage._colorMap.get( ResourceManager.get_instance().get( "edit.object.dialog.tree.list")) : table.getBackground());
			} else if ( value instanceof MapObject) {
				setForeground( isSelected ? Color.white : VariablePropertyPage._colorMap.get( ResourceManager.get_instance().get( "edit.object.dialog.tree.map")));
				setBackground( isSelected ? VariablePropertyPage._colorMap.get( ResourceManager.get_instance().get( "edit.object.dialog.tree.map")) : table.getBackground());
			} else if ( value instanceof ExchangeAlgebraObject) {
				setForeground( isSelected ? Color.white : VariablePropertyPage._colorMap.get( ResourceManager.get_instance().get( "edit.object.dialog.tree.exchange.algebra")));
				setBackground( isSelected ? VariablePropertyPage._colorMap.get( ResourceManager.get_instance().get( "edit.object.dialog.tree.exchange.algebra")) : table.getBackground());
			}
		}
