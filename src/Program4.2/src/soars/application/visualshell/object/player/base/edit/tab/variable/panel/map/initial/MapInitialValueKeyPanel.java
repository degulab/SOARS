 ...
 * 
 */
package soars.application.visualshell.object.player.base.edit.tab.variable.panel.map.initial;
...
import soars.application.visualshell.object.player.base.edit.tab.variable.panel.map.initial.panel.key.ImmediateDataPanel;
import soars.application.visualshell.object.player.base.edit.tab.variable.panel.map.initial.panel.key.KeywordSelectorPanel;
...
public class MapInitialValueKeyPanel extends JPanel {
	 ...
	 */
	public MapInitialValueKeyPanel(Color color, PlayerBase playerBase, Map<String, PropertyPageBase> propertyPageMap) {
		super();
		_color = color;
		...
		_typeComboBox.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if ( item.equals( ResourceManager.get_instance().get( "edit.map.value.dialog.map.key.keyword")))
					_keywordSelectorPanel.update( item, _playerBase, _propertyPageMap);
				revalidate();
				repaint();
			}
		});
	...
	public void on_setup_completed() {
		_keywordSelectorPanel.update( ResourceManager.get_instance().get( "edit.map.value.dialog.map.key.keyword"), _playerBase, _propertyPageMap);
