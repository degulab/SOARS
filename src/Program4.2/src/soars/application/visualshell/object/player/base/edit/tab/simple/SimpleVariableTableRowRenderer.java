	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
		...
		if ( null != value && value instanceof SimpleVariableObject) {
			...
			if ( value instanceof ProbabilityObject) {
				...
				setForeground( isSelected ? Color.white : SimpleVariablePropertyPage._colorMap.get( ResourceManager.get_instance().get( "edit.object.dialog.tree.keyword")));
				setBackground( isSelected ? SimpleVariablePropertyPage._colorMap.get( ResourceManager.get_instance().get( "edit.object.dialog.tree.keyword")) : table.getBackground());
			} else if ( value instanceof NumberObject) {
				setForeground( isSelected ? Color.white : SimpleVariablePropertyPage._colorMap.get( ResourceManager.get_instance().get( "edit.object.dialog.tree.number.object")));
				setBackground( isSelected ? SimpleVariablePropertyPage._colorMap.get( ResourceManager.get_instance().get( "edit.object.dialog.tree.number.object")) : table.getBackground());
			} else if ( value instanceof RoleVariableObject) {
