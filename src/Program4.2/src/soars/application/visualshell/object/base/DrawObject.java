...
public class DrawObject {
	 ...
	 * @param graphics2D the graphics object of JAVA
	 */
	public DrawObject(int id, String name, Point position, String imageFilename, Graphics2D graphics2D) {
		super();
		_id = id;
		_name = name;
		_position = new Point( position);
...
//			|| ( type.equals( "spot") && !( this instanceof SpotObject))
		if ( ( ( type.equals( "agent") || type.equals( "spot")) && !( this instanceof PlayerBase))
