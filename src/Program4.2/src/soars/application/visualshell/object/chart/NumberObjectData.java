...
public class NumberObjectData {
	 ...
	 */
	public boolean can_adjust_name(String type, String headName, Vector ranges, ChartObject chartObject) {
	 ...
	 */
	public boolean can_adjust_name(String type, String headName, Vector ranges, String newHeadName, Vector newRanges, ChartObject chartObject) {
		if ( !_type.equals( type))
			return true;
	 ...
	 */
	public boolean can_remove(String type, String numberVariable, String headName, Vector ranges, ChartObject chartObject) {
	 ...
	 */
	public boolean update_object_name(String player, String name, String newName) {
	...
	public boolean can_paste(Layer drawObjects, ChartObject chartObject) {
		...
		if ( _type.equals( "agent"))
			playerBase = drawObjects.get_agent_has_this_name( _objectName);
		else if ( _type.equals( "spot"))
			playerBase = drawObjects.get_spot_has_this_name( _objectName);
		...
		if ( null == playerBase) {
			...
			if ( !playerBase.has_same_object_name( "number object", _numberVariable)) {
				String[] message = new String[] {
					"Chart",
					"name = " + chartObject._name,
					_type + " name = " + _objectName,
