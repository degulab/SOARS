...
public class EditChartObjectDlg extends Dialog implements ITextUndoRedoManagerCallBack {
	...
	protected boolean on_init_dialog() {
		...
		setup_nameTextField( north_panel);

		insert_horizontal_glue( north_panel);

		setup_commentTextField( north_panel);

		insert_horizontal_glue( north_panel);

		setup_titleTextField( north_panel);

		insert_horizontal_glue( north_panel);

		setup_horizontalAxisTextField( north_panel);

		insert_horizontal_glue( north_panel);

		setup_verticalAxisTextField( north_panel);

		insert_horizontal_glue( north_panel);

		setup_connectCheckBox( north_panel);
		...
		if ( !setup_numberObjectPairsTable( center_panel))
			return false;
		...
		setup_appendNumberObjectDataPairButton( south_panel);
	 ...
	 * @param north_panel
	 */
	private void setup_nameTextField(JPanel north_panel) {
		int pad = 5;
	 ...
	 * @param north_panel
	 */
	private void setup_commentTextField(JPanel north_panel) {
		int pad = 5;
	 ...
	 * @param north_panel
	 */
	private void setup_titleTextField(JPanel north_panel) {
		int pad = 5;
	 ...
	 * @param north_panel
	 */
	private void setup_horizontalAxisTextField(JPanel north_panel) {
		int pad = 5;
	 ...
	 * @param north_panel
	 */
	private void setup_verticalAxisTextField(JPanel north_panel) {
		int pad = 5;
	 ...
	 * @param north_panel
	 */
	private void setup_connectCheckBox(JPanel north_panel) {
		int pad = 5;
	 ...
	 * @return
	 */
	private boolean setup_numberObjectPairsTable(JPanel center_panel) {
		int pad = 5;
	 ...
	 * @param south_panel
	 */
	private void setup_appendNumberObjectDataPairButton(JPanel south_panel) {
		JPanel panel = new JPanel();
		panel.setLayout( new BoxLayout( panel, BoxLayout.X_AXIS));
		...
		button_panel.add( _appendNumberObjectDataPairButton);
