...
public class ChartObject extends DrawObject {
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.base.DrawObject#can_remove(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.Vector)
	 */
	public boolean can_remove(String kind, String type, String name, String headName, Vector ranges) {
	 ...
	 */
	public boolean update_object_name(String kind, String player, String name, String newName) {
		if ( !kind.equals( "number object"))
			return false;
		...
		for ( NumberObjectData[] numberObjectDataPair:_numberObjectDataPairs) {
			for ( NumberObjectData numberObjectData:numberObjectDataPair) {
				if ( numberObjectData.update_object_name( player, name, newName))
					result = true;
			}
		}
		return result;
