...
public class StageList extends ListBase implements DropTargetListener {
	 ...
	 * 
	 */
	public Point _drop_position = null;
	 ...
	 * @return
	 */
	public boolean setup(Vector stages, StageList[] stageLists, StageListTransferHandler stageListTransferHandler) {
		...
		for ( int i = 0; i < stages.size(); ++i) {
			StageCheckBox stageCheckBox = new StageCheckBox( ( Stage)stages.get( i));
	...
	protected void on_mouse_right_up(MouseEvent mouseEvent) {
		...
		_remove_menuItem.setEnabled( null == _editRoleFrame);
...
//			}
	 ...
	 * @param stages
	 */
	public void on_ok(Vector stages) {
		stages.clear();
		DefaultComboBoxModel defaultComboBoxModel = ( DefaultComboBoxModel)getModel();
		for ( int i = 0; i < defaultComboBoxModel.getSize(); ++i) {
			StageCheckBox stageCheckBox = ( StageCheckBox)defaultComboBoxModel.getElementAt( i);
	...
	public void drop(DropTargetDropEvent arg0) {
		_drop_position = arg0.getLocation();
	}
