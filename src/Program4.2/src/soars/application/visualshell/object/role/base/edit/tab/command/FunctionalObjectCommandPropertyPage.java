...
import soars.application.visualshell.object.role.base.edit.tab.common.functional_object.EditReturnValueDlg;
 ...
 *
 */
public class FunctionalObjectCommandPropertyPage extends FunctionalObjectPropertyPageBase {
	 ...
	 * @param parent
	 */
	public FunctionalObjectCommandPropertyPage(String title, String kind,
		String type, Color color, Role role, int index, Frame owner, EditRoleFrame parent) {
		super(title, kind, type, color, role, index, owner, parent);
	}

	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.role.base.rule.edit.tab.common.functional_object.FunctionalObjectPropertyPageBase#get_return_value()
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.role.base.rule.edit.tab.common.functional_object.FunctionalObjectPropertyPageBase#set_return_value(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.role.base.rule.edit.tab.common.functional_object.FunctionalObjectPropertyPageBase#set_enable_return_value_button(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.role.base.rule.edit.tab.common.functional_object.FunctionalObjectPropertyPageBase#setup_return_value_textField(javax.swing.JPanel)
	 */
