 ...
 * @author kurata
 */
public class EquipCommandPropertyPageBase extends RulePropertyPageBase {
	 ...
	 * @param parent
	 */
	public EquipCommandPropertyPageBase(String title, String kind,
...
//				}
		...
		_spotCheckBox.setEnabled( this instanceof AgentEquipCommandPropertyPage);
...
//		_labels.add( label);
	...
	private void setup_spot_selector(JPanel parent) {
		...
		label = create_label(
			this instanceof AgentEquipCommandPropertyPage
		...
		_spotSelector = create_spot_selector(
			true,	//this instanceof AgentEquipCommandPropertyPage,
			true, panel);
...
//				_labels.get( 1).getPreferredSize().height));
	...
	protected void reset(ObjectSelector objectSelector, CheckBox spotVariableCheckBox, ComboBox spotVariableComboBox) {
		...
		if ( this instanceof AgentEquipCommandPropertyPage) {
...
//		}
	...
	public void on_setup_completed() {
		CommonTool.update( _comboBoxes.get( 0).get( 0), ( this instanceof AgentEquipCommandPropertyPage) ? get_agent_probability_names( false) : get_spot_probability_names( false));
		CommonTool.update( _comboBoxes.get( 1).get( 0), ( this instanceof AgentEquipCommandPropertyPage) ? get_agent_collection_names( false) : get_spot_collection_names( false));
		CommonTool.update( _comboBoxes.get( 2).get( 0), ( this instanceof AgentEquipCommandPropertyPage) ? get_agent_list_names( false) : get_spot_list_names( false));
		CommonTool.update( _comboBoxes.get( 3).get( 0), ( this instanceof AgentEquipCommandPropertyPage) ? get_agent_map_names( false) : get_spot_map_names( false));
		CommonTool.update( _comboBoxes.get( 4).get( 0), ( this instanceof AgentEquipCommandPropertyPage) ? get_agent_keyword_names( false) : get_spot_keyword_names( false));
		CommonTool.update( _comboBoxes.get( 5).get( 0), ( this instanceof AgentEquipCommandPropertyPage) ? get_agent_number_object_names( false) : get_spot_number_object_names( false));
		CommonTool.update( _comboBoxes.get( 6).get( 0), ( this instanceof AgentEquipCommandPropertyPage) ? get_agent_time_variable_names( false) : get_spot_time_variable_names( false));
		CommonTool.update( _comboBoxes.get( 7).get( 0), ( this instanceof AgentEquipCommandPropertyPage) ? get_agent_spot_variable_names( false) : get_spot_spot_variable_names( false));
