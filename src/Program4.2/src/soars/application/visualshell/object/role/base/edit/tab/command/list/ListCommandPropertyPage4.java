 ...
 *
 */
public class ListCommandPropertyPage4 extends CollectionAndListCommandPropertyPageBase {
	 ...
	 * @param parent
	 */
	public ListCommandPropertyPage4(String title, String kind,
	...
	private void setup_remove_spot(ButtonGroup buttonGroup1, JPanel parent) {
		...
		_radioButtons1[ 0] = create_radioButton(
			ResourceManager.get_instance().get( "edit.rule.dialog.command.list.remove.spot"),
		...
		_label[ 1] = create_label( "  " +
			ResourceManager.get_instance().get( "edit.rule.dialog.command.list.label.remove.spot"),
			true);
		panel.add( _label[ 1]);
	...
	private void setup_remove_agent(ButtonGroup buttonGroup1, JPanel parent) {
		...
		_radioButtons1[ 1] = create_radioButton(
			ResourceManager.get_instance().get( "edit.rule.dialog.command.list.remove.agent"),
			buttonGroup1, true, false);
		...
		_label[ 2] = create_label( "  " +
			ResourceManager.get_instance().get( "edit.rule.dialog.command.list.label.remove.agent"),
			true);
		panel.add( _label[ 2]);
	...
	private void setup_remove_string(ButtonGroup buttonGroup1, JPanel parent) {
		...
		_radioButtons1[ 2] = create_radioButton(
			ResourceManager.get_instance().get( "edit.rule.dialog.command.list.remove.string"),
			buttonGroup1, true, false);
		...
		_label[ 3] = create_label( "  " +
			ResourceManager.get_instance().get( "edit.rule.dialog.command.list.label.remove.string"),
			true);
		panel.add( _label[ 3]);
	...
	private void setup_remove_equip(ButtonGroup buttonGroup1, JPanel parent) {
		...
		_radioButtons1[ 5] = create_radioButton(
			ResourceManager.get_instance().get( "edit.rule.dialog.command.list.remove.equip"),
			buttonGroup1, true, false);
		...
		_radioButtons2[ 0][ 0] = create_radioButton(
			ResourceManager.get_instance().get( "edit.rule.dialog.command.list.remove.equip.probability"),
		...
		_radioButtons2[ 0][ 1] = create_radioButton(
			ResourceManager.get_instance().get( "edit.rule.dialog.command.list.remove.equip.keyword"),
			buttonGroup2, true, false);
		...
		_radioButtons2[ 0][ 2] = create_radioButton(
			ResourceManager.get_instance().get( "edit.rule.dialog.command.list.remove.equip.number.object"),
			buttonGroup2, true, false);
		...
		_radioButtons2[ 0][ 3] = create_radioButton(
			ResourceManager.get_instance().get( "edit.rule.dialog.command.list.remove.equip.object"),
			buttonGroup2, true, false);
	...
	private void update_components(boolean[] enables) {
		...
		_remove_all_list_comboBox.setEnabled( enables[ 3]);

		_label[ 5].setEnabled( enables[ 4]);
		_remove_all_collection_comboBox.setEnabled( enables[ 4]);
	...
	public boolean set(Rule rule) {
		...
		if ( 22 > kind || 30 < kind) {
			set_handler();
			return false;
		} else if ( 22 <= kind && 26 >= kind) {
			_radioButtons1[ kind - 22].setSelected( true);
		} else if ( 27 <= kind && 30 >= kind) {
			_radioButtons1[ 5].setSelected( true);
			_radioButtons2[ 0][ kind - 27].setSelected( true);
		} else
			return false;
	...
	public Rule get() {
		...
		if ( 5 > kind)
			...
			kind = ( 27 + SwingTool.get_enabled_radioButton( _radioButtons2[ 0]));
		else
			return null;
