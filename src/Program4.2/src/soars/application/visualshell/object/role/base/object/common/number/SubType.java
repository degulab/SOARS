...
public class SubType {
	 ...
	 * @return
	 */
	public static SubType get(String value, String[] sub_types) {
		...
		if ( 2 == elements.length) {
			...
			int kind1 = get_kind( elements[ 0], sub_types);
			if ( 0 > kind1)
				return null;
			...
			int kind2 = get_kind( elements[ 2], sub_types);
			if ( 0 > kind2)
				return null;
	 ...
	 * @return
	 */
	private static int get_kind(String value, String[] sub_types) {
		for ( int i = 0; i < sub_types.length; ++i) {
			if ( sub_types[ i].equals( value))
				return i;
		}
		return -1;
	}
	 ...
	 * @param sub_types
	 */
	public String get(String[] sub_types) {
		if ( null == _operator || _operator.equals( ""))
			return ( sub_types[ _kind[ 0]] + " none: ");
		else
			return ( sub_types[ _kind[ 0]] + " " + _operator + " " + sub_types[ _kind[ 1]] + ": ");
	}
