...
public class SpotVariableCommand extends Rule {
	 ...
	 * @return
	 */
	public static String get_rule_value(String spot_variable, String spot) {
		return ( spot_variable + " " + spot.substring( 1, spot.length() - 1));
	}
	...
	public boolean update_spot_name_and_number(String new_name, String original_name, String head_name, Vector ranges, String new_head_name, Vector new_ranges) {
		...
		elements[ 1] = CommonRuleManipulator.update_spot_name1( elements[ 1], new_name, original_name, head_name, ranges, new_head_name, new_ranges);
		if ( null == elements[ 1])
			return false;
	...
	protected boolean update_spot_variable_name(String name, String new_name, String type, Role role) {
		...
		String element = CommonRuleManipulator.update_spot_variable_name1( elements[ 1], name, new_name, type);
		if ( null != element) {
			elements[ 1] = element;
			result2 = true;
		}
