 ...
 */
package soars.application.visualshell.object.role.base.object.common.common;
...
public class CommonRuleManipulator {
	 ...
	 * @return
	 */
	public static String update_spot_name1(String element, String newName, String originalName, String headName, Vector ranges, String newHeadName, Vector newRanges) {
	 ...
	 * @return
	 */
	private static String update_spot_name1(String element, String newName, String originalName, String headName, Vector ranges, String newHeadName, Vector newRanges, ILayerManipulator layerManipulator) {
		if ( null == element)
			return null;
		...
		String new_spot_name = get_new_agent_or_spot_name( words[ 0], newName, originalName, headName, ranges, newHeadName, newRanges);
		if ( null == new_spot_name)
			return null;

		return ( new_spot_name + ( ( 1 < words.length) ? ( ":" + words[ 1]) : ""));
	}
	 ...
	 * @return
	 */
	public static String update_spot_name2(String value, String newName, String originalName, String headName, Vector ranges, String newHeadName, Vector newRanges) {
	 ...
	 * @return
	 */
	private static String update_spot_name2(String value, String newName, String originalName, String headName, Vector ranges, String newHeadName, Vector newRanges, ILayerManipulator layerManipulator) {
	 ...
	 * @return
	 */
	public static boolean update_spot_name3(String[] values, String newName, String originalName, String headName, Vector ranges, String newHeadName, Vector newRanges) {
	 ...
	 * @return
	 */
	private static boolean update_spot_name3(String[] values, String newName, String originalName, String headName, Vector ranges, String newHeadName, Vector newRanges, ILayerManipulator layerManipulator) {
		if ( null == values)
			return false;
		...
		String new_spot_name = get_new_agent_or_spot_name( values[ 0], newName, originalName, headName, ranges, newHeadName, newRanges);
		if ( null == new_spot_name)
			return false;

		values[ 0] = new_spot_name;
	 ...
	 * @return
	 */
	public static String get_new_agent_or_spot_name(String name, String newName, String originalName, String headName, Vector ranges, String newHeadName, Vector newRanges) {
	 ...
	 * @return
	 */
	public static String what_kind_object_is(String element) {
		// TODO Auto-generated method stub
		for ( String kind:Constant._kinds) {
			if ( is_object( kind, element, LayerManager.get_instance()))
				return kind;
		}
		return null;
	}
	 ...
	 */
	public static boolean correspond(String target, String objectName, boolean otherSpotsHaveThisObjectName, String headName, Vector ranges) {
		...
		String spot_name = elements[ 0].substring( "<".length());
		if ( null == spot_name)
			return false;

		if ( !SoarsCommonTool.has_same_name( headName, ranges, spot_name))
			return false;
	...
	public static String update_object_name(String target, String objectName, String newObjectName, String type) {
		if ( type.equals( "agent")) {
			...
			if ( elements[ 0].equals( "<"))
				...
				return ( objectName.equals( elements[ 1]) ? ( "<" + spot_name + ">" + newObjectName) : null);
			}
		}
