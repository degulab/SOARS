...
public class ListCondition extends Rule {
	...
	protected String[] get_used_agent_names() {
		String used_agent_name = CollectionAndListCondition.get_used_agent_name( this);
		if ( null == used_agent_name)
			used_agent_name = get_used_agent_name();

		return new String[] { used_agent_name};
	}
	...
	protected String[] get_used_spot_names() {
		String[] used_spot_names = CollectionAndListCondition.get_used_spot_names( this);
...
//		String used_spot_variable_name = CollectionAndListCondition.get_used_spot_variable_name( this);
//		if ( null == used_spot_variable_name)
//			used_spot_variable_name = get_used_spot_variable_name();
//
...
//		String[] used_list_names = CollectionAndListCondition.get_used_list_names( this);
//		if ( null != used_list_names)
...
//		if ( CollectionAndListCondition.update_spot_variable_name(name, new_name, type, this))
//			return true;
//
//		int kind = get_kind( _value);
//		if ( 0 > kind)
...
//		return CollectionAndListCondition.update_probability_name(name, new_name, type, this);
		// TODO 要動作確認！
...
//		return CollectionAndListCondition.update_collection_name(name, new_name, type, this);
		// TODO 要動作確認！
...
//		if ( CollectionAndListCondition.update_list_name(name, new_name, type, this))
//			return true;
//
//		int kind = get_kind( _value);
//		if ( 0 > kind)
...
//		return CollectionAndListCondition.update_number_object_name(name, new_name, type, this);
		// TODO 要動作確認！
