...
public class FunctionalObject {
	 ...
	 * @param returnValue
	 */
	public FunctionalObject(String[] spots, String classVariable, String method, List parameters, String[] returnValue) {
		super();
		_spots = spots;
	 ...
	 * @param list
	 */
	private void get_object_name(String type, List list) {
		// TODO Auto-generated method stub
...
//		return ( ( ( null == _spot) ? "" : "<" + _spot + ">") + _class_variable);
	 ...
	 * @param list
	 */
	private void get_parameter_names(String type, List list) {
		if ( null == _parameters)
			return;
	 ...
	 * @param list
	 */
	private void get_return_value_name(String type, List list) {
	 ...
	 * @param list
	 */
	private void get_object_name(String type, String[] value, List list) {
		// TODO Auto-generated method stub
	 ...
	 * @param list
	 */
	private void get_probability_name(String[] value, List list) {
	 ...
	 * @param list
	 */
	private void get_collection_name(String[] value, List list) {
	 ...
	 * @param list
	 */
	private void get_list_name(String[] value, List list) {
		if ( ( value[ 1].equals( "java.util.Collection")
	 ...
	 * @param list
	 */
	private void get_map_name(String[] value, List list) {
	 ...
	 * @param list
	 */
	private void get_keyword_name(String[] value, List list) {
	 ...
	 * @param list
	 */
	private void get_number_object_name(String[] value, List list) {
	 ...
	 * @param list
	 */
	private void get_file_name(String[] value, List list) {
	 ...
	 * @param list
	 */
	private void get_role_variable_name(String[] value, List list) {
		if ( !value[ 1].equals( "int")
			&& !value[ 1].equals( "byte")
			&& !value[ 1].equals( "short")
			&& !value[ 1].equals( "long")
	 ...
	 * @param list
	 */
	private void get_time_variable_name(String[] value, List list) {
		if ( !value[ 1].equals( "int")
			&& !value[ 1].equals( "byte")
			&& !value[ 1].equals( "short")
			&& !value[ 1].equals( "long")
	 ...
	 * @param list
	 */
	private void get_spot_variable_name(String[] value, List list) {
		if ( !value[ 1].equals( "int")
			&& !value[ 1].equals( "byte")
			&& !value[ 1].equals( "short")
			&& !value[ 1].equals( "long")
	 ...
	 * @param list
	 */
	private void get_class_variable_name(String[] value, List list) {
		if ( !value[ 1].equals( "int")
			&& !value[ 1].equals( "byte")
			&& !value[ 1].equals( "short")
			&& !value[ 1].equals( "long")
	 ...
	 * @param list
	 */
	private void get_exchange_algebra_name(String[] value, List list) {
		if ( !value[ 1].equals( "int")
			&& !value[ 1].equals( "byte")
			&& !value[ 1].equals( "short")
			&& !value[ 1].equals( "long")
	 ...
	 * @param list
	 */
	private void append(String value, List list) {
	 ...
	 * @param list
	 */
	private void get_agent_name(String[] value, List list) {
		// TODO Auto-generated method stub
	 ...
	 * @param list
	 */
	private void get_spot_name(String[] value, List list) {
		// TODO Auto-generated method stub
	 ...
	 * @return
	 */
	public boolean update_agent_name(String newName, String originalName, String headName, Vector ranges, String newHeadName, Vector newRanges, Rule rule) {
		// TODO Auto-generated method stub
	 ...
	 * @return
	 */
	public boolean update_spot_name(String newName, String originalName, String head_name, Vector ranges, String newHeadName, Vector newRanges, Rule rule) {
		// TODO Auto-generated method stub
		boolean result1 = update_parameter_name( "env.Spot", newName, originalName, head_name, ranges, newHeadName, newRanges);
		boolean result2 = update_return_value_name( "env.Spot", newName, originalName, head_name, ranges, newHeadName, newRanges);
		boolean result3 = CommonRuleManipulator.update_spot_name3( _spots, newName, originalName, head_name, ranges, newHeadName, newRanges);
	 ...
	 * @return
	 */
	private boolean update_parameter_name(String type, String newName, String originalName, String headName, Vector ranges, String newHeadName, Vector newRanges) {
		// TODO Auto-generated method stub
		if ( null == _parameters)
			return false;
	 ...
	 * @return
	 */
	private boolean update_return_value_name(String type, String newName, String originalName, String headName, Vector ranges, String newHeadName, Vector newRanges) {
		// TODO Auto-generated method stub
		if ( null == _returnValue)
			return false;
	 ...
	 * @return
	 */
	private boolean update_agent_or_spot_name(String type, String[] value, String newName, String originalName, String headName, Vector ranges, String newHeadName, Vector newRanges) {
		// TODO Auto-generated method stub
