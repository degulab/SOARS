 ...
 * @author kurata
 */
public class EditRuleValuePropertyPage extends RulePropertyPageBase {
	 ...
	 * 
	 */
	private int _value_textField_width = _standardControlWidth;
	 ...
	 * @param parent
	 */
	public EditRuleValuePropertyPage(String title, String kind, String type, Color color, Role role, int index, String label, boolean can_empty, Frame owner, EditRoleFrame parent) {
	 ...
	 * @param index
	 * @param label
	 * @param value_textField_width
	 * @param can_empty
	 * @param owner
	 * @param parent
	 */
	public EditRuleValuePropertyPage(String title, String kind, String type, Color color, Role role, int index, String label, int value_textField_width, boolean can_empty, Frame owner, EditRoleFrame parent) {
		super(title, kind, type, color, role, index, owner, parent);
		_label = label;
		_value_textField_width = value_textField_width;
		_can_empty = can_empty;
	}
	...
	public void set(String value) {
		if ( null == _value_textField)
			return;

		_value_textField.setText( value);
	}
	...
	protected boolean on_create() {
		...
		setup_value_text_field( north_panel);
	...
	private void setup_value_text_field(JPanel parent) {
		...
		_value_textField = create_textField( _value_textField_width/*500*/, false);
	...
	public boolean set(Rule rule) {
		...
		_value_textField.setText( rule._value);
		return true;
	}
	 ...
	 */
	public Rule get() {
		String value = _value_textField.getText();
