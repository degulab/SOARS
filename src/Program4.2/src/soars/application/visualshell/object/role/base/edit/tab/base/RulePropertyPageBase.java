 ...
 * @author kurata
 */
public class RulePropertyPageBase extends TabbedPage implements IObjectSelectorHandler {
...
//	protected int _applyButtonWidth = 100;
	 ...
	 * @param parent
	 */
	public RulePropertyPageBase(String title, String kind, String type, Color color, Role role, int index, Frame owner, EditRoleFrame parent) {
		super();
		_title = title;
		_kind = kind;
		_type = type;
	 ...
	 * @param parent
	 */
	public RulePropertyPageBase(String title, String kind, String type, Role role, int index, Frame owner, EditRoleFrame parent) {
		super();
		_title = title;
		_kind = kind;
		_type = type;
	 ...
	 * @param parent
	 */
	public RulePropertyPageBase(String title, String kind, Color color, Role role, int index, Frame owner, EditRoleFrame parent) {
		super();
		_title = title;
		_kind = kind;
		_color = color;
	 ...
	 * @param parent
	 */
	public RulePropertyPageBase(String title, String kind, Role role, int index, Frame owner, EditRoleFrame parent) {
		super();
		_title = title;
		_kind = kind;
		_role = role;
