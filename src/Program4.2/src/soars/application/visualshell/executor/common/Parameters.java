...
public class Parameters {
	 ...
	 */
	static private final String _root_directory_name = "simulator";
	...
	private boolean setup_work_directory() {
		...
		_rootDirectory = new File( _parentDirectory, _root_directory_name);
	 ...
	 * @return
	 */
	private boolean setup_graphic_properties_file(String graphicProperties) {
	 ...
	 * @return
	 */
	private boolean setup_chart_properties_file(String chartProperties) {
