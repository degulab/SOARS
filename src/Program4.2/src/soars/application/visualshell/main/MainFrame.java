...
import soars.application.visualshell.file.exporter.java.edit.ExportJavaProgramDlg;
...
import soars.application.visualshell.menu.file.ExportJavaProgramAction;
...
//	private JMenuItem _fileSaveAsMenuItem = null;
	 ...
	 * 
	 */
	private JMenuItem _fileExportJavaProgramMenuItem = null;
	 ...
	 * 
	 */
	private Map _menuTextMap = new HashMap();
...
//		_menuTextMap.put( _fileNewMenuItem.getText(), Boolean.valueOf( true));
//
//
...
//		_menuTextMap.put( _fileOpenMenuItem.getText(), Boolean.valueOf( true));
//
//
//		menu.addSeparator();
//
...
//		_menuTextMap.put( _fileCloseMenuItem.getText(), Boolean.valueOf( true));
//
//
//		menu.addSeparator();
		...
		_menuTextMap.put( _fileSaveMenuItem.getText(), Boolean.valueOf( true));
...
//		_menuTextMap.put( _fileSaveAsMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _fileExportToSoarsEngineMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _fileExportToFileMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _fileExportToClipboardMenuItem.getText(), Boolean.valueOf( true));
		...
		if ( Environment.get_instance().is_initial_data_enable()) {
			...
			_menuTextMap.put( _fileImportInitialDataMenuItem.getText(), Boolean.valueOf( true));
			...
			_menuTextMap.put( _fileExportInitialDataMenuItem.getText(), Boolean.valueOf( true));
		...
		ExportJavaProgramAction exportJavaProgramAction = new ExportJavaProgramAction( ResourceManager.get_instance().get( "file.export.java.program.menu"));
		_fileExportJavaProgramMenuItem = _userInterface.append_menuitem(
			menu,
			ResourceManager.get_instance().get( "file.export.java.program.menu"),
			exportJavaProgramAction,
			ResourceManager.get_instance().get( "file.export.java.program.mnemonic"),
			ResourceManager.get_instance().get( "file.export.java.program.stroke"),
			_messageLabel,
			ResourceManager.get_instance().get( "file.export.java.program.message"));
		_menuTextMap.put( _fileExportJavaProgramMenuItem.getText(), Boolean.valueOf( true));
		...
		if ( Environment.get_instance().is_gis_enable()) {
			...
			_menuTextMap.put( _fileOpenGisDataMenuItem.getText(), Boolean.valueOf( true));
			...
			_menuTextMap.put( _fileImportGisDataMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _fileCreateDockerFilesetMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( ResourceManager.get_instance().get( "file.exit.menu"), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editEditMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editRemoveMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editMoveMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editCopyMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editPasteMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editSelectAllMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editDeselectAllMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editFlushTopMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editFlushBottomMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editFlushLeftMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editFlushRightMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editVerticalEqualLayoutMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editHorizontalEqualLayoutMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editSwapNamesMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editCopyObjectsMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _editPasteObjectsMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _settingStageMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _settingSimulationMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _settingExpressionMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _settingLog1MenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _settingLog2MenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _settingCommentMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _settingExperimentMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _runModelBuilderMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _runSimulatorMenuItem.getText(), Boolean.valueOf( true));
...
//		_menuTextMap.put( _run_model_builder_without_animator_menuItem.getText(), Boolean.valueOf( true));
//
//
...
//		_menuTextMap.put( _run_animator_menuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( _optionApplicationSettingMenuItem.getText(), Boolean.valueOf( true));
		...
		_menuTextMap.put( ResourceManager.get_instance().get( "help.forum.menu"), Boolean.valueOf( true));
		...
		_menuTextMap.put( ResourceManager.get_instance().get( "help.about.menu"), Boolean.valueOf( true));
...
//		//_run_animator_button.setEnabled( false);
		...
		HashMap button_keyword_map = new HashMap();
		...
		_toolboxAgentButton = _userInterface.append_tool_button(
			toolBar,
			imageIcon,
			new ButtonTransferHandler( "text", button_keyword_map),
		...
		button_keyword_map.put( _toolboxAgentButton, "agent");
		...
		button_keyword_map.put( _toolboxSpotButton, "spot");
		...
		button_keyword_map.put( _toolboxAgentRoleButton, "agent_role");
		...
		button_keyword_map.put( _toolboxSpotRoleButton, "spot_role");
		...
		button_keyword_map.put( _toolboxChartButton, "chart");
	 ...
	 * @return
	 */
	private boolean setup_plugin_menu(Map menuTextMap) {
		return PluginManager.get_instance().setup_menu( _userInterface, _messageLabel, this, menuTextMap);
	}

	/**
	 * Enables the specified plugins.
	 * @param execute_plugins the array of the specified plugins
	 */
	public void execute_plugin(List execute_plugins) {
		for ( int i = 0; i < execute_plugins.size(); ++i) {
			String plugin_name = ( String)execute_plugins.get( i);
			PluginManager.get_instance().execute( plugin_name, this);
		}
	}
	...
	private void update_user_interface(boolean fileNew, boolean fileOpen,
		...
		boolean fileExport, boolean fileExportToClipboard, boolean fileExportJavaProgram,
...
//		_fileSaveAsMenuItem.setEnabled( fileSaveAs);
		...
		_fileExportJavaProgramMenuItem.setEnabled( fileExportJavaProgram);
...
//		if ( -1 == index)
//			file = new File( absolute_name + ".vsl");
...
//			ResourceManager.get( "file.import.dialog"),
//			new String[] { "sor", "txt"},
//			"SOARS script data",
//			this);
//
...
//				true, true, ( 1 < _layer_comboBox.getItemCount()));
	...
	public void on_file_export_initial_data(ActionEvent actionEvent) {
		...
		int index = name.lastIndexOf( '.');
		if ( -1 == index)
			file = new File( absolute_name + ".txt");
		else if ( name.length() - 1 == index)
			file = new File( absolute_name + "txt");
	...
	public void on_file_export_to_file(ActionEvent actionEvent) {
		...
		int index = name.lastIndexOf( '.');
		if ( -1 == index)
			file = new File( absolute_name + ".sor");
		else if ( name.length() - 1 == index)
			file = new File( absolute_name + "sor");
	 ...
	 * @param actionEvent
	 */
	public void on_file_export_java_program(ActionEvent actionEvent) {
		// TODO Auto-generated method stub
		VisualShellView.get_instance().cancel();

		ExportJavaProgramDlg exportJavaProgramDlg = new ExportJavaProgramDlg( this, ResourceManager.get_instance().get( "file.export.java.program.menu"), true);
		if ( !exportJavaProgramDlg.do_modal())
			return;

		requestFocus();

		if ( Environment.get_instance().get( Environment._exportJavaProgramDirectoryKey, "").equals( "")) {
			JOptionPane.showMessageDialog(
				this,
		...
		File folder = new File( Environment.get_instance().get( Environment._exportJavaProgramDirectoryKey, ""));
		...
		if ( !ExperimentManager.get_instance().isEmpty()
			...
			&& ExperimentManager.get_instance().can_export_to_clipboard()) {
			if ( !ExperimentManager.get_instance().export_java_program( folder,
				Environment.get_instance().get( Environment._exportJavaProgramPackagePathKey, "soars2/model")))
				JOptionPane.showMessageDialog(
					this,
					ResourceManager.get_instance().get( "file.export.java.program.show.error.message"),
					ResourceManager.get_instance().get( "application.title"),
					JOptionPane.ERROR_MESSAGE);
		} else {
			if ( !VisualShellView.get_instance().on_file_export_java_program( folder,
				Environment.get_instance().get( Environment._exportJavaProgramPackagePathKey, "soars2/model")))
				JOptionPane.showMessageDialog(
					this,
					ResourceManager.get_instance().get( "file.export.java.program.show.error.message"),
...
//		_file_export_to_clipboard_button.setEnabled( ExperimentManager.get_instance().can_export_to_clipboard());
		...
		_fileExportJavaProgramMenuItem.setEnabled( ExperimentManager.get_instance().can_export_to_clipboard());
	}
