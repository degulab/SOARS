...
public class Environment extends EnvironmentBase {
	...
	/**
	 * Key mapped to the position and size of the java program export dialog box.
	 */
	static public final String _exportJavaProgramDialogRectangleKey = "Export.java.program.dialog.rectangle.";

	/**
	 * Key mapped to the default directory for the java program export.
	 */
	static public final String _exportJavaProgramDirectoryKey = "Directory.java.program.export";

	/**
	 * Key mapped to the default java class path for the java program export.
	 */
	static public final String _exportJavaProgramPackagePathKey = "Package.path.java.program.export";

	/**
	 * Key mapped to the default indent type ( "tab" or "space") for the java program export.
	 */
	static public final String _exportJavaProgramDialogIndentTypeKey = "Indent.type.java.program.export";

	/**
	 * Key mapped to the default number of space in indent for the java program export.
	 */
	static public final String _exportJavaProgramDialogNumberOfSpaceForIndentKey = "number.of.space.for.indent.java.program.export";
	 ...
	 */
	static public String _editObjectDialogClassVariablePropertyPageDividerLocationKey= "Edit.object.dialog.class.property.page.divider.location";
	 ...
	 */
	static public final String _editObjectDialogFilePropertyPageDividerLocationKey = "Edit.object.dialog.file.property.page.divider.location";
	 ...
	 * Key mapped to the divider position of the property page to edit the file variables.
	 */
	static public final String _editObjectDialogInitialDataFilePropertyPageDividerLocationKey = "Edit.object.dialog.initial.data.file.property.page.divider.location";
	 ...
	 * Key mapped to the divider position of the property page to edit the file variables.
	 */
	static public final String _editObjectDialogExTransferPropertyPageDividerLocationKey = "Edit.object.dialog.extransfer.property.page.divider.location";
	 ...
	 * @param plugin_name the name of the specified plugin
	 */
	public void append_enable_plugin(String plugin_name) {
		String value = get( _enablePluginsKey, "");

		if ( value.equals( "")) {
			set( _enablePluginsKey, plugin_name);
			return;
		}

		String[] enable_plugin_names = value.split( ";");
		if ( null == enable_plugin_names || 0 == enable_plugin_names.length) {
			set( _enablePluginsKey, plugin_name);
			return;
		}

		List enable_plugins = new ArrayList( Arrays.asList( enable_plugin_names));
		if ( enable_plugins.contains( plugin_name))
			return;
