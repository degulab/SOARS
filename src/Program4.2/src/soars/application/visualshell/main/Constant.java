...
public class Constant extends CommonConstant {
	 ...
	 */
	static public final String _version = "4.2.4";

	/**
	 * Application version string.
	 */
	static public final String _applicationVersion = "20210310";
...
//	static public final String[] _functionalObjectDirectories = {
//		_systemModuleDirectory,
//		_userModuleDirectory,
...
//	};
	...
	static public boolean initialize_functionalObjectDirectories() {
		...
		_functionalObjectDirectories = new String[ 4];
		// この順序を変えてはいけない！グリッド上へjarファイルを転送出来なくなる
		_functionalObjectDirectories[ 0] = _systemModuleDirectory;
		_functionalObjectDirectories[ 1] = userModuleDirectory.getAbsolutePath().replaceAll( "\\\\", "/");
		_functionalObjectDirectories[ 2] = "../library/exalge";
		_functionalObjectDirectories[ 3] = "../library/auxiliary";
	...
	/**
	 * Names of all property pages.
	 */
	static public final String[] _propertyPages = new String[] {
		"simple variable",
		"variable",
		"class variable",
		"file",
	...
	/**
	 * Names of all exceptional property pages.
	 */
	static public final String[] _exceptionalPropertyPages = new String[] {
		"initial data file"
	};
	...
	public static String get_version_message() {
		return ( _version/*SoarsCommonEnvironment.get_instance().get( SoarsCommonEnvironment._versionKey, "SOARS")*/ + _lineSeparator
	...
	/**
	 * Returns the array of property pages except the specified one.
	 * @param kind the specified property page
	 * @return the array of property pages except the specified one.
	 */
	public static String[] get_property_pages(String kind) {
		List list = new ArrayList();
		for ( int i = 0; i < _propertyPages.length; ++i) {
			if ( _propertyPages[ i].equals( kind))
				continue;

			list.add( _propertyPages[ i]);
		}
