...
public class Observer {
	 ...
	 * @param all
	 */
	public void on_update_playerBase(boolean all) {
	 ...
	 * @return
	 */
	public boolean on_update_object_name_and_number(String newName, String originalName, String headName, Vector ranges, String newHeadName, Vector newRanges, PlayerBase playerBase) {
