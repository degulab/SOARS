...
public class WarningDlg3 extends Dialog {
	 ...
	 * 
	 */
	private String _forced_execution_message = "";
	 ...
	 * 
	 */
	public boolean _forced_execution = false;
	...
	public WarningDlg3(Frame arg0, String arg1, String message, String forced_execution_message, Component parent) {
		...
		_message = message;
		_forced_execution_message = forced_execution_message;
		_parent = parent;
	}
	...
	protected boolean on_init_dialog() {
		...
		setup_forced_execution_button( southg_panel);
	 ...
	 * @param southg_panel
	 */
	private void setup_forced_execution_button(JPanel southg_panel) {
		JPanel panel = new JPanel();
		panel.setLayout( new BoxLayout( panel, BoxLayout.X_AXIS));
