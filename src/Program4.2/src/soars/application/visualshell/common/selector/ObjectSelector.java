...
public class ObjectSelector extends JPanel implements INumberSpinnerHandler {
	 ...
	 */
	public ObjectSelector(String type, boolean contains_empty, Color color, boolean right, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		setup_layout( layoutManager);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, String[] names, Color color, boolean right, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		setup_layout( layoutManager);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, String full_name, boolean contains_empty, Color color, boolean right, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		setup_layout( layoutManager);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, String full_name, String[] names, Color color, boolean right, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		setup_layout( layoutManager);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, boolean contains_empty, int comboBox_width, int numberSpinner_width, Color color, boolean right, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		setup_layout( layoutManager);
		setup( null, contains_empty, color, right, tabbedPage);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, String[] names, int comboBox_width, int numberSpinner_width, Color color, boolean right, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		setup_layout( layoutManager);
		setup( null, names, color, right, tabbedPage);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, String full_name, boolean contains_empty, int comboBox_width, int numberSpinner_width, Color color, boolean right, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		setup_layout( layoutManager);
		setup( full_name, contains_empty, color, right, tabbedPage);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, String full_name, String[] names, int comboBox_width, int numberSpinner_width, Color color, boolean right, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		setup_layout( layoutManager);
		setup( full_name, names, color, right, tabbedPage);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, boolean contains_empty, Color color, boolean right, IObjectSelectorHandler objectSelectorHandler, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		_objectSelectorHandler = objectSelectorHandler;
		setup_layout( layoutManager);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, String[] names, Color color, boolean right, IObjectSelectorHandler objectSelectorHandler, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		_objectSelectorHandler = objectSelectorHandler;
		setup_layout( layoutManager);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, String full_name, boolean contains_empty, Color color, boolean right, IObjectSelectorHandler objectSelectorHandler, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		_objectSelectorHandler = objectSelectorHandler;
		setup_layout( layoutManager);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, String full_name, String[] names, Color color, boolean right, IObjectSelectorHandler objectSelectorHandler, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		_objectSelectorHandler = objectSelectorHandler;
		setup_layout( layoutManager);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, boolean contains_empty, int comboBox_width, int numberSpinner_width, Color color, boolean right, IObjectSelectorHandler objectSelectorHandler, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		_objectSelectorHandler = objectSelectorHandler;
		setup_layout( layoutManager);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, String[] names, int comboBox_width, int numberSpinner_width, Color color, boolean right, IObjectSelectorHandler objectSelectorHandler, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		_objectSelectorHandler = objectSelectorHandler;
		setup_layout( layoutManager);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, String full_name, boolean contains_empty, int comboBox_width, int numberSpinner_width, Color color, boolean right, IObjectSelectorHandler objectSelectorHandler, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		_objectSelectorHandler = objectSelectorHandler;
		setup_layout( layoutManager);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	public ObjectSelector(String type, String full_name, String[] names, int comboBox_width, int numberSpinner_width, Color color, boolean right, IObjectSelectorHandler objectSelectorHandler, LayoutManager layoutManager, TabbedPage tabbedPage) {
		super();
		_type = type;
		_objectSelectorHandler = objectSelectorHandler;
		setup_layout( layoutManager);
	 ...
	 * @param tabbedPage the component which has this object
	 */
	private void setup(String full_name, boolean contains_empty, Color color, boolean right, TabbedPage tabbedPage) {
		String[] names = null;
		if ( _type.equals( "agent"))
			names = LayerManager.get_instance().get_agent_names( contains_empty);
		else
	 ...
	 * @param tabbedPage the component which has this object
	 */
	private void setup(String full_name, String[] names, Color color, boolean right, TabbedPage tabbedPage) {
	...
	protected void on_action_performed(ActionEvent actionEvent) {
		...
		if ( null == name || name.equals( ""))
			...
			if ( playerBase._number.equals( "")) {
				_numberSpinner.setEnabled( false);
			} else {
				int max_number = Integer.parseInt( playerBase._number);
				_numberSpinner.set_maximum( max_number);

				int number = _numberSpinner.get_value();
				if ( number > max_number)
					_numberSpinner.setValue( Integer.valueOf( max_number));
	...
	public void set(String full_name) {
		...
		if ( null == full_name || full_name.equals( "")) {
			...
			if ( _type.equals( "agent"))
				playerBase = LayerManager.get_instance().get_agent( full_name);
			else
				playerBase = LayerManager.get_instance().get_spot( full_name);
			...
			if ( null != playerBase) {
				...
				if ( _type.equals( "agent"))
					playerBase = LayerManager.get_instance().get_agent_has_this_name( full_name);
				else
					playerBase = LayerManager.get_instance().get_spot_has_this_name( full_name);
				...
				if ( null == playerBase) {
					...
					String number_text = full_name.substring( playerBase._name.length());
					...
					if ( 1 > number || number > max_number) {
						...
						_objectNameComboBox.setSelectedItem( playerBase._name);
	...
	public void selectFirstItem() {
		...
		name += ( playerBase._number.equals( "") ? "" : "1");
