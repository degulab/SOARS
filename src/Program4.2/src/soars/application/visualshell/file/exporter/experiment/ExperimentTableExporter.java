...
public class ExperimentTableExporter {
	 ...
	 * @param table_data the array of the values for the experiments
	 * @return true for exporting the experiment table data to the specified file in CSV format successfully
	 */
	public static boolean execute(File file, String[] aliases, String[] comments, String[][] table_data) {
		String script = get_script( aliases, comments, table_data);
	 ...
	 * @return
	 */
	private static String get_script(String[] aliases, String[] comments, String[][] table_data) {
