 ...
 * 2005/07/01
 */
package soars.application.animator.file.importer.legacy;
...
/**
 * The XML SAX loader for legacy Animator graphics data.
 * @author kurata / SOARS project
 */
public class LegacyGraphicDataSaxLoader extends DefaultHandler {
	...
	/**
	 * Parent directory which contains XML file of legacy Animator graphics data.
	 */
	 ...
	 * @param file the XML file of legacy Animator graphics data
	...
	public static boolean execute(File file, Graphics2D graphics2D) {
		...
		try {
			...
			LegacyGraphicDataSaxLoader legacyGraphicDataSaxLoader = new LegacyGraphicDataSaxLoader( file.getParentFile(), graphics2D);
			saxParser.parse( file, legacyGraphicDataSaxLoader);
			legacyGraphicDataSaxLoader.at_end_of_load();
		} catch (Exception e) {
			e.printStackTrace();
			return false;
		}
	...
	/**
	 * Creates the XML SAX loader for legacy Animator graphics data.
	 * @param file_directory the parent directory which contains XML file of legacy Animator graphics data
	 * @param graphics2D the graphics object of JAVA
	 */
	public LegacyGraphicDataSaxLoader(File file_directory, Graphics2D graphics2D) {
		super();
