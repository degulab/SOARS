 ...
 * 2005/02/07
 */
package soars.application.animator.object.player.spot;
...
import soars.application.animator.object.player.base.edit.object.EditImageObjectDlg;
import soars.application.animator.object.player.base.edit.object.EditObjectDlg;
 ...
 */
public class SpotObject extends ObjectBase implements ISpotObjectManipulator {
	 ...
	 */
	public SpotObject(String name, ISpotObjectManipulator parent) {
		super(name, new Color( 0, ( int)( 255 * Math.random()), ( int)( 255 * Math.random())), new Color( 0, 0, 255));
		_parent = parent;
	}
	 ...
	 */
	public SpotObject(String name, ISpotObjectManipulator parent, Graphics2D graphics2D) {
		super(name, new Color( 0, ( int)( 255 * Math.random()), ( int)( 255 * Math.random())), new Color( 0, 0, 255));
		_parent = parent;
	 ...
	 * Creates the instance of spot object class.
	 * @param name the name of spot
	 * @param visible_name true if the name string is visible
	 * @param position the position of this spot
	 * @param image_object true if this object has only image
	 * @param parent the parent of this spot
	 * @param graphics2D the graphics object of JAVA
	 */
	public SpotObject(String name, boolean visible_name, Point position, boolean image_object, ISpotObjectManipulator parent, Graphics2D graphics2D) {
		super(name, new Color( 0, ( int)( 255 * Math.random()), ( int)( 255 * Math.random())), new Color( 0, 0, 255));
		_visibleName = visible_name;
		_imageObject = image_object;
		_parent = parent;
		Font font = graphics2D.getFont();
		_font = new Font( font.getFamily(), font.getStyle(), font.getSize());
		setup_dimension( graphics2D);
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#is_image_object()
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#setup(java.awt.Graphics2D)
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#cleanup()
	 */
	public void cleanup() {
		super.cleanup();
	}
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#get_name()
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#is_visible()
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#update_dimension()
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#append(soars.application.animator.object.player.agent.AgentObject)
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#get_position()
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#set_position(int, int)
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#get_image_position()
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#get_dimension()
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#update_dimension(int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#restore_image_size()
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#update_preferred_size(java.awt.Dimension, java.awt.Dimension, java.awt.Dimension, int)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#get_size(java.awt.Dimension, java.awt.Dimension, java.awt.Dimension, int)
	 */
...
//			width = CommonProperty.get_instance()._minimumWidth;
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#load_image(java.lang.String)
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#load_image_from_resource(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#uses_this_image(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#update_image(java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#set_image(java.lang.String, java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#update(java.lang.String, java.lang.String, int, int, java.util.Map)
	 */
		...
		if ( number.equals( "")) {
			...
			if ( SoarsCommonTool.has_same_name( name, String.valueOf( number), _name)) {
				...
				if ( null != integer) {
					...
					integer = Integer.valueOf( counter);
				}

				counterMap.put( name, Integer.valueOf( counter));
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#draw(java.awt.Graphics2D, java.awt.Rectangle, java.awt.image.ImageObserver)
	 */
	public void draw(Graphics2D graphics2D, Rectangle rectangle, ImageObserver imageObserver) {
		...
		if ( null != bufferedImage) {
			...
			if ( !_imageObject)
				SpotPropertyManager.get_instance().draw_current_property_image( graphics2D, _imagePosition, bufferedImage.getHeight(), CommonProperty.get_instance()._spotWidth, CommonProperty.get_instance()._spotHeight, _properties, rectangle, imageObserver, true);
		} else {
			if ( _imageObject)
				// TODO Auto-generated method stub
				...
				if ( !SpotPropertyManager.get_instance().draw_current_property_image( graphics2D, _imagePosition, CommonProperty.get_instance()._spotHeight, CommonProperty.get_instance()._spotWidth, CommonProperty.get_instance()._spotHeight, _properties, rectangle, imageObserver, false))
...
//		} else {
			...
			if ( null != bufferedImage) {
				...
				if ( _imageObject)
					...
					if ( !ScenarioManager.get_instance().draw_current_spot_property_image( this, graphics2D, _imagePosition, CommonProperty.get_instance()._spotHeight, CommonProperty.get_instance()._spotWidth, CommonProperty.get_instance()._spotHeight, rectangle, imageObserver, false))
						draw_default_image( rectangle, graphics2D, _imagePosition, CommonProperty.get_instance()._spotWidth, CommonProperty.get_instance()._spotHeight);
				}
			}
//		}
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.base.ObjectBase#draw_default_image(java.awt.Graphics2D, int, int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#get_agent_position(soars.application.animator.object.player.agent.AgentObject, boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#get_agent_position(soars.application.animator.object.player.agent.AgentObject, int, int, boolean)
	 */
...
//			width = CommonProperty.get_instance()._minimumWidth;
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#get_spot(java.awt.Point)
	 */
...
//			return this;
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#select(boolean)
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#select_all_objects(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#select_all_spot_objects(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#select_all_image_objects(boolean)
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#select(java.awt.Rectangle)
	 */
...
//				|| rectangle.intersects( new Rectangle( _position, _nameDimension)));
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#move_to_top()
	 */
	public void move_to_top() {
	}

	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#move_to_bottom()
	 */
	public void move_to_bottom() {
	}

	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#move_to_front()
	 */
	public void move_to_front() {
	}

	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#move_to_back()
	 */
	public void move_to_back() {
	}

	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#test(int, int)
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#move(int, int, boolean)
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#move_to(int, int, boolean)
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#edit(java.awt.Frame)
	 */
	public boolean edit(Frame frame) {
		if ( !is_image_object()) {
			EditObjectDlg editObjectDlg = new EditObjectDlg( frame,
				ResourceManager.get( "edit.spot.dialog.title"),
			...
			EditImageObjectDlg editImageObjectDlg = new EditImageObjectDlg( frame,
				ResourceManager.get( "edit.image.object.dialog.title"),
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.base.ObjectBase#update(boolean, boolean, int, int, int, int, int, int, java.lang.String, int, int, java.lang.String, java.awt.Graphics2D)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.base.ObjectBase#update(int, int, int, java.lang.String, java.awt.Graphics2D)
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.base.ObjectBase#update_image(java.lang.String)
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#get_tooltip_text(java.lang.String)
	 */
	public String get_tooltip_text(String state) {
		...
		if ( state.equals( "animation"))
			return _name + ScenarioManager.get_instance().get_tooltip_text( this, SpotTransitionManager.get_instance(), SpotPropertyManager.get_instance().get_selected_properties());
		else if ( state.equals( "edit"))
			return get_tooltip_text( SpotPropertyManager.get_instance().get_selected_properties());
		return null;
	}

	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#is_unique_name(java.lang.String)
	 */
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#write(soars.common.utility.xml.sax.Writer)
	 */
	...
	/* (non-Javadoc)
	 * @see soars.application.animator.object.player.spot.ISpotObjectManipulator#write_graphic_data(java.io.File, soars.common.utility.xml.sax.Writer)
	 */
