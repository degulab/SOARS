...
public class EditPropertyOrderDlg extends Dialog {
	...
	protected boolean on_init_dialog() {
		...
		JPanel parent_panel = setup_selected_properties_list();

		JPanel button_panel = setup_up_button();

		setup_down_button( button_panel);

		parent_panel.add( button_panel);
		getContentPane().add( parent_panel);
	...
	private JPanel setup_selected_properties_list() {
		...
		JLabel label = new JLabel(
			ResourceManager.get( "edit.property.order.dialog.list"));
		panel.add( label);
		...
		parent_panel.setLayout( new FlowLayout( FlowLayout.LEFT, 5, 0));
	...
	private JPanel setup_up_button() {
		...
		_up_button = new JButton(
			ResourceManager.get( "edit.property.order.dialog.up.button"));
		_up_button.setEnabled( false);
	...
	private void setup_down_button(JPanel button_panel) {
		...
		_down_button = new JButton(
			ResourceManager.get( "edit.property.order.dialog.down.button"));
		_down_button.setEnabled( false);
