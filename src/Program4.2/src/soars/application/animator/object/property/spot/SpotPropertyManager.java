...
public class SpotPropertyManager extends PropertyManager {
	 ...
	 * 
	 */
	static private SpotPropertyManager _spotPropertyManager = null;
	...
	/**
	 * Returns the instance of the SpotProperty hasshtable.
	 * @return the instance of the SpotProperty hasshtable
	 */
	public static SpotPropertyManager get_instance() {
		if ( null == _spotPropertyManager) {
			System.exit( 0);
		}

		return _spotPropertyManager;
	}
...
//	/**
//	 * Creates the instance of the SpotProperty hasshtable with the specified SpotProperty hasshtable.
//	 * @param spotPropertyManager the specified SpotProperty hasshtable
//	 */
...
//			y -= spotProperty._text_image.getHeight();
	...
	public boolean edit(Frame frame) {
		return edit( ResourceManager.get( "edit.spot.properties.dialog.title"),
	...
	public boolean write_graphic_data(File root_directory, Writer writer) throws SAXException {
		return write_graphic_data( root_directory, writer, "spot");
	}
}
