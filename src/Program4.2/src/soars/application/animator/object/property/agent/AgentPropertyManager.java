...
public class AgentPropertyManager extends PropertyManager {
	 ...
	 * 
	 */
	static private AgentPropertyManager _agentPropertyManager = null;
	...
	/**
	 * Returns the instance of the AgentProperty hasshtable.
	 * @return the instance of the AgentProperty hasshtable
	 */
	public static AgentPropertyManager get_instance() {
		if ( null == _agentPropertyManager) {
			System.exit( 0);
		}

		return _agentPropertyManager;
	}
...
//	/**
//	 * Creates the instance of the AgentProperty hasshtable with the specified AgentProperty hasshtable.
//	 * @param agentPropertyManager the specified AgentProperty hasshtable
//	 */
...
//
//	/* (Non Javadoc)
//	 * @see soars.application.animator.object.property.base.PropertyManager#create(soars.application.animator.scenario.property.base.PropertyBase)
//	 */
...
//	}
	 ...
	 */
	public boolean draw_current_property_image(Graphics2D graphics2D, Point position, int width, int height, Map<String, String> properties, Rectangle rectangle, ImageObserver imageObserver, boolean image_exists) {
		boolean result = super.draw_current_property_image( graphics2D, position, width, height, properties, rectangle, imageObserver, image_exists);
...
//			y += agentProperty._text_image.getHeight();
	 ...
	 */
	public boolean draw_current_property_image(Graphics2D graphics2D, Point position, int width, int height, TransitionBase transitionBase, Rectangle rectangle, ImageObserver imageObserver, boolean image_exists) {
		boolean result = super.draw_current_property_image( graphics2D, position, width, height, transitionBase, rectangle, imageObserver, image_exists);
...
//			y += agentProperty._text_image.getHeight();
	...
	/* (Non Javadoc)
	 * @see soars.application.animator.object.property.base.PropertyManager#edit(java.awt.Frame)
	 */
	public boolean edit(Frame frame) {
		return edit( ResourceManager.get( "edit.agent.properties.dialog.title"),
	...
	public boolean write_graphic_data(File root_directory, Writer writer) throws SAXException {
		return write_graphic_data( root_directory, writer, "agent");
	}
}
