...
public class ChartTree extends StandardTree {
	 ...
	 */
	public boolean setup(boolean popup_menu) {
		if ( !super.setup(popup_menu))
			return false;

		DefaultTreeModel defaultTreeModel = ( DefaultTreeModel)getModel();
		DefaultMutableTreeNode root = new DefaultMutableTreeNode( ResourceManager.get( "chart.display.setting.dialog.chart.tree.root.text"));
