...
public class RetrieveObject {
	...
	public int retrieve_backward(String value, int start_position) {
		...
		try {
			randomAccessFile = new RandomAccessFile( _headerObject._indices_file, "r");
	 ...
	 */
	public int retrieve_backward_more_than(double value, int start_position) {
		if ( !_fileObject.open())
			return -1;
	 ...
	 */
	public int retrieve_backward_less_than(double value, int start_position) {
		if ( !_fileObject.open())
			return -1;
	 ...
	 */
	public int retrieve_backward_more_than_less_than(double value0, double value1, int start_position) {
		if ( !_fileObject.open())
			return -1;
	 ...
	 */
	public int retrieve_forward(String value, int start_position) {
		if ( !_fileObject.open())
			return -1;
		...
		try {
			...
			long previous_position = -1l;
			for ( int i = start_position; i < _headerObject._size; ++i) {
				fileChannel.position( ( ( long)i * _headerObject._length) + 8l + 4l + 4l + ( 8l * ( long)_index));
				long position = randomAccessFile.readLong();
				if ( position == previous_position)
					continue;
	 ...
	 */
	public int retrieve_forward_more_than(double value, int start_position) {
		if ( !_fileObject.open())
			return -1;
	 ...
	 */
	public int retrieve_forward_less_than(double value, int start_position) {
		if ( !_fileObject.open())
			return -1;
	 ...
	 */
	public int retrieve_forward_more_than_less_than(double value0, double value1, int start_position) {
		if ( !_fileObject.open())
			return -1;
