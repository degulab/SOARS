 ...
 */
public class EditSelectedObjectDlg extends Dialog {
	 ...
	 * 
	 */
	private Vector<ObjectBase> _objects = null;
	 ...
	 */
	public EditSelectedObjectDlg(Frame arg0, String arg1, boolean arg2, String openDirectoryKey, Vector<ObjectBase> objects) {
	...
	private boolean setup_west_panel(ObjectBase objectBase, JPanel parent) {
		...
		setup_visible( objectBase, north_panel);
		...
		setup_font( objectBase, north_panel);
	 ...
	 * @param parent
	 */
	private void setup_visible(ObjectBase objectBase, JPanel parent) {
		_visiblePanel.setup( objectBase._visible, objectBase._visibleName, this);
	...
	private void setup_color(ObjectBase objectBase, JPanel parent) {
		_colorPanel.setup( objectBase._imageColor, objectBase._textColor, this);
	 ...
	 * @param parent
	 */
	private void setup_font(ObjectBase objectBase, JPanel parent) {
		_fontPanel.setup( objectBase._font, this);
	...
	protected void on_ok(ActionEvent actionEvent) {
		...
		boolean visibleName = _visiblePanel._visible_name_check_box.isSelected();
		Color imageColor = _colorPanel._image_color_label.getBackground();
		Color textColor = _colorPanel._text_color_label.getBackground();
		String fontFamily = ( String)_fontPanel._font_family_combo_box.getSelectedItem();
		int fontStyle = CommonTool.get_font_style( ( String)_fontPanel._font_style_combo_box.getSelectedItem());
		int fontSize = Integer.parseInt( ( String)_fontPanel._font_size_combo_box.getSelectedItem());
		...
		for ( int i = 0; i < _objects.size(); ++i) {
			...
			objectBase.update( visible, visibleName,
