...
public class SelectedImagefilePanel extends JPanel implements IThumbnailListCallback {
	 ...
	 */
	static private BufferedImage _bufferedImage = new BufferedImage( AnimatorImageManager._thumbnail_size, AnimatorImageManager._thumbnail_size, BufferedImage.TYPE_INT_ARGB);
	...
	public boolean setup(String image_filename) {
		...
		panel.setBorder( BorderFactory.createTitledBorder(
			ResourceManager.get( "selected.imagefile.panel.border.title")));
	...
	private void setup_selected_image_size_text_field(JPanel parent) {
		...
		_selected_image_size_label = new JLabel(
			ResourceManager.get( "selected.imagefile.panel.imagefile.size"));
	...
	private void setup_selected_image_filename_text_field(JPanel parent) {
		...
		_selected_image_filename_label = new JLabel(
			ResourceManager.get( "selected.imagefile.panel.imagefile.name"));
	...
	private void setup_select_imagefile_check_box(String image_filename, JPanel parent) {
		...
		_imagefile_check_box = new JCheckBox(
			ResourceManager.get( "selected.imagefile.panel.imagefile.checkbox"),
	...
	public void update() {
		...
		File file = new File( ObjectManager.get_instance().get_thumbnail_image_directory(), filename);
