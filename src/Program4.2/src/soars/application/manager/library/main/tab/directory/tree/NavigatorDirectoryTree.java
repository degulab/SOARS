...
public class NavigatorDirectoryTree extends DirectoryTree2 implements IContextMenuHandler {
	...
	protected void setup_popup_menu() {
		...
		_editModuleMenuItem = _userInterface.append_popup_menuitem(
			_popupMenu,
			ResourceManager.get( "popup.menu.edit.module.menu"),
			new EditModuleAction( ResourceManager.get( "popup.menu.edit.module.menu"), this),
			ResourceManager.get( "popup.menu.edit.module.mnemonic"),
			ResourceManager.get( "popup.menu.edit.module.stroke"));

		_popupMenu.addSeparator();

		_enableModuleMenuItem = _userInterface.append_popup_menuitem(
			_popupMenu,
			ResourceManager.get( "popup.menu.enable.module.menu"),
			new EnableModuleAction( ResourceManager.get( "popup.menu.enable.module.menu"), this),
			ResourceManager.get( "popup.menu.enable.module.mnemonic"),
			ResourceManager.get( "popup.menu.enable.module.stroke"));
		_disableModuleMenuItem = _userInterface.append_popup_menuitem(
			_popupMenu,
			ResourceManager.get( "popup.menu.disable.module.menu"),
			new DisableModuleAction( ResourceManager.get( "popup.menu.disable.module.menu"), this),
			ResourceManager.get( "popup.menu.disable.module.mnemonic"),
			ResourceManager.get( "popup.menu.disable.module.stroke"));
	}
...
//			&& ( null != Module.get_module( ( File)defaultMutableTreeNode.getUserObject())));
	...
	public void on_edit_module(ActionEvent actionEvent) {
		...
		EditModuleDlg editModuleDlg = new EditModuleDlg( _owner, ResourceManager.get( "edit.module.dialog.title"), true, module);
