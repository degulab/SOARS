...
public class Components extends JPanel implements ITextUndoRedoManagerCallBack {
	...
	private void setup_center_panel(JPanel parent) {
		...
		JLabel label = new JLabel( ResourceManager.get( "annotation.components.name"));
		...
		label = new JLabel( ResourceManager.get( "annotation.components.comment"));
		label.setHorizontalAlignment( SwingConstants.RIGHT);
		_labels.add( label);
		...
		parent.setBorder( new ComponentTitledBorder( new JLabel( ResourceManager.get( "annotation.components.border." + _language)), this, BorderFactory.createLineBorder( getForeground())));
	}
