...
public class LiveLogViewerFrame extends LogViewerFrame {
	...
	public boolean start(Reader reader, final StdOutStreamPumper stdOutStreamPumper, final StdErrOutStreamPumper stdErrOutStreamPumper) {
		...
		_tabbedConsole = new JTabbedConsole( _tabbedPane,
			ResourceManager.get( "log.viewer.console.title") + " - " + ResourceManager.get( "log.viewer.state.waiting"),
			ResourceManager.get( "log.viewer.console.title") + " - " + ResourceManager.get( "log.viewer.state.finished"));
...
//						}
						_tabbedConsole.setTitle( ResourceManager.get( "log.viewer.console.title") + " - " + ResourceManager.get( "log.viewer.state.running"));
					...
					//e.printStackTrace();
					_tabbedConsole.setTitle( ResourceManager.get( "log.viewer.console.title") + " - " + ResourceManager.get( "log.viewer.state.aborted"));
...
//				JOptionPane.showMessageDialog( MainFrame.get_instance(), "MainFrame.get_instance().on_terminate()", ResourceManager.get( "application.title"), JOptionPane.INFORMATION_MESSAGE);
			}
		}).start();
	...
	public boolean update(String log_viewer_window_title, Rectangle window_rectangle, String console, List agents, List spots, String stdout, String stderr) {
		_tabbedConsole.setTitle( ResourceManager.get( "log.viewer.console.title"));
