...
public class SaxLoader extends DefaultHandler {
	...
	private void on_file_manager(Attributes attributes) {
		...
		_fileManagerData._window_rectangle.x = ( ( null == value || value.equals( "")) ? 0 : Integer.parseInt( value));

		value = attributes.getValue( "y");
		_fileManagerData._window_rectangle.y = ( ( null == value || value.equals( "")) ? 0 : Integer.parseInt( value));

		value = attributes.getValue( "width");
		_fileManagerData._window_rectangle.width = ( ( null == value || value.equals( "")) ? 0 : Integer.parseInt( value));

		value = attributes.getValue( "height");
		_fileManagerData._window_rectangle.height = ( ( null == value || value.equals( "")) ? 0 : Integer.parseInt( value));

		value = attributes.getValue( "divider_location");
		_fileManagerData._divider_location = ( ( null == value || value.equals( "")) ? 100 : Integer.parseInt( value));

		value = attributes.getValue( "current_directory");
		if ( null == value)
			value = "";

		_fileManagerData._current_directory = value;
