...
public class FileTable extends FileTableBase implements IContextMenuHandler {
	...
	protected void setup_popup_menu() {
		...
		_updateAnnotationFileMenuItem = _userInterface.append_popup_menuitem(
			_popupMenu,
			ResourceManager.get( "popup.menu.update.annotation.file.menu"),
			new UpdateAnnotationFileAction( ResourceManager.get( "popup.menu.update.annotation.file.menu"), this),
			ResourceManager.get( "popup.menu.update.annotation.file.mnemonic"),
			ResourceManager.get( "popup.menu.update.annotation.file.stroke"));
	}
