...
public class GAGridMonitorDlg extends GAMonitorDlg implements ITimerTaskImplementCallback {
	...
	protected void on_cancel(ActionEvent actionEvent) {
		...
		if ( JOptionPane.YES_OPTION != JOptionPane.showConfirmDialog( _parent,
			ResourceManager.get( "plugin.ga1.frame.exit.confirm.message"), getTitle(), JOptionPane.YES_NO_OPTION))
			return;
	...
	protected void setup_grid_panel(JPanel parent) {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.ga1.grid.frame"));
	...
	private void setup_grid_portal_ip_address_textField(JPanel parent) {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.ga1.grid.frame.gird.portal.ip.address"), SwingConstants.RIGHT);
	...
	private void setup_local_username_textField(JPanel parent) {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.ga1.grid.frame.username"), SwingConstants.RIGHT);
		_components.add( label);
		panel.add( label);
	...
	private void setup_script_directory_textField(JPanel parent) {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.ga1.grid.frame.script.directory"), SwingConstants.RIGHT);
		_components.add( label);
		panel.add( label);
	...
	private void setup_log_directory_textField(JPanel parent) {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.ga1.grid.frame.log.directory"), SwingConstants.RIGHT);
		_components.add( label);
		panel.add( label);
	...
	private void setup_model_builder_memory_size_textField(JPanel parent) {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.ga1.grid.frame.model.builder.memory.size"), SwingConstants.RIGHT);
		_components.add( label);
		panel.add( label);
	...
	private void setup_number_of_submitted_scripts_textField(JPanel parent) {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.ga1.grid.frame.number.of.submitted.script"), SwingConstants.RIGHT);
		_components.add( label);
		panel.add( label);
	...
	protected void on_stop(ActionEvent actionEvent) {
		if ( !_termination
			&& JOptionPane.YES_OPTION != JOptionPane.showConfirmDialog( _parent,
				ResourceManager.get( "plugin.ga1.frame.cancel.confirm.message"), getTitle(), JOptionPane.YES_NO_OPTION))
			return;
