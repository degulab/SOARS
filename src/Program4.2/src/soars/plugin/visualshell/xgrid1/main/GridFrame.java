...
public class GridFrame extends Frame implements Runnable, ITimerTaskImplementCallback {
	...
	protected void on_window_closing(WindowEvent windowEvent) {
		if ( JOptionPane.YES_OPTION != JOptionPane.showConfirmDialog( this,
			ResourceManager.get( "plugin.xgrid1.frame.exit.confirm.message"), getTitle(), JOptionPane.YES_NO_OPTION))
			return;
	...
	private void setup_gridPortalIpAddressTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.frame.gird.portal.ip.address"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
	...
	private void setup_usernameTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.frame.username"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
	...
	private void setup_scriptDirectoryTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.frame.script.directory"), SwingConstants.RIGHT);
	...
	private void setup_logDirectoryTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.frame.log.directory"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
	...
	private void setup_modelBuilderMemorySizeTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.frame.model.builder.memory.size"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
	...
	private void setup_numberOfTimesTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.frame.number.of.times"), SwingConstants.RIGHT);
		label.setEnabled( _environment.get( Environment._simulationKey, "false").equals( "true"));
		_labels.add( label);
		panel.add( label);
	...
	private void setup_localLogDirectoryTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.frame.local.log.directory"), SwingConstants.RIGHT);
	...
	private void setup_numberOfScriptsTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.frame.number.of.script"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
	...
	private void setup_numberOfSubmittedScriptsTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.frame.number.of.submitted.script"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
	...
	private void setup_statusTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.frame.status"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
	...
	private void setup_progressBar() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.frame.progress"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
	...
	private void setup_errorLogTextArea() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.frame.error.log"));
		panel.add( label);
	...
	private void setup_stopButton() {
		...
		_stopButton = new JButton( ResourceManager.get( "dialog.cancel"));
	...
	protected void on_stop(ActionEvent actionEvent) {
		if ( !_termination
			&& JOptionPane.YES_OPTION != JOptionPane.showConfirmDialog( this,
				ResourceManager.get( "plugin.xgrid1.frame.cancel.confirm.message"), getTitle(), JOptionPane.YES_NO_OPTION))
			return;
	...
	private void on_stop() {
		...
		JOptionPane.showMessageDialog( this,
			ResourceManager.get( "plugin.xgrid1.frame.canceled"),
			getTitle(),
			JOptionPane.INFORMATION_MESSAGE);
		_statusTextField.setText( "Canceled ...");
		_statusTextField.update( _statusTextField.getGraphics());
		_errorLogTextArea.append( ResourceManager.get( "plugin.xgrid1.frame.canceled"));
		setEnabled( true);
	...
	private boolean export_soars_scripts() {
		...
		if ( !Reflection.execute_class_method( object, "export_data_for_grid",
			...
			new Object[] { _experimentManager,
				...
				Integer.valueOf( _environment.get( Environment._numberOfTimesForGridKey, "1")),
