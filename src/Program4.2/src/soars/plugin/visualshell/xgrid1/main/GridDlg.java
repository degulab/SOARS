	...
	public static boolean execute(String name, File file, JFrame frame, String hostname, String usersDirectory, String javaHome, String applicationDirectory) {
		...
		if ( null == resultList || resultList.isEmpty()) {
			JOptionPane.showMessageDialog(
				frame,
				ResourceManager.get( "plugin.xgrid1.error.message.no.script"),
				ResourceManager.get( "plugin.xgrid1.dialog.title"),
		...
		GridLoginDlg gridLoginDlg = new GridLoginDlg(
			frame,
			ResourceManager.get( "plugin.xgrid1.login.dialog.title"),
			true,
			usersDirectory,
			parameters);
...
//		patch( rootDirectory, parameters._username);
		...
		GridFrame gridFrame = new GridFrame(
			ResourceManager.get( "plugin.xgrid1.frame.title")
...
//	}
	...
	private void setup_gridPortalIpAddressTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.dialog.gird.portal.ip.address"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
	...
	private void setup_localUsernameTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.dialog.username"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
	...
	private void setup_scriptDirectoryTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.dialog.script.directory"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
		...
		_scriptDirectorySelectorButton = new JButton( ResourceManager.get( "plugin.xgrid1.dialog.script.reference"));
	...
	protected void on_scriptDirectorySelectorButton_actionPerformed(ActionEvent actionEvent) {
		String directory = Tool.get_remote_directory( _scriptDirectoryTextField.getText(),
			ResourceManager.get( "plugin.xgrid1.script.directory.selector.dialog.title"),
	...
	private void setup_logDirectoryTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.dialog.log.directory"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
		...
		_logDirectorySelectorButton = new JButton( ResourceManager.get( "plugin.xgrid1.dialog.log.reference"));
	...
	protected void on_logDirectorySelectorButton_actionPerformed(ActionEvent actionEvent) {
		String directory = Tool.get_remote_directory( _logDirectoryTextField.getText(),
			ResourceManager.get( "plugin.xgrid1.log.directory.selector.dialog.title"),
			( Frame)getOwner(), this, _parameters._gridPortalIpAddress, _parameters._username, _parameters._privateKeyFilename,
			_parameters._dataDirectoryName);
		if ( null == directory)
			return;
	...
	private void setup_modelBuilderMemorySizeNumberSpinner() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.dialog.model.builder.memory.size"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
	...
	private void setup_simulationCheckBox() {
		...
		_simulationCheckBox = new JCheckBox(
			ResourceManager.get( "plugin.xgrid1.dialog.simulation"),
	...
	private void setup_numberOfTimesNumberSpinner() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.dialog.number.of.times"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
	...
	private void setup_transferLogCheckBox() {
		...
		_transferLogCheckBox = new JCheckBox(
			ResourceManager.get( "plugin.xgrid1.dialog.log.transfer"),
	...
	private void setup_localLogDirectoryTextField() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.dialog.local.log.directory"), SwingConstants.RIGHT);
		_labels.add( label);
		panel.add( label);
		...
		_localLogDirectorySelectorButton = new JButton( ResourceManager.get( "plugin.xgrid1.dialog.local.log.reference"));
	...
	protected void on_localLogDirectorySelectorButton_actionPerformed(ActionEvent actionEvent) {
		File directory = Tool.get_directory( _localLogDirectoryTextField.getText(),
			ResourceManager.get( "plugin.xgrid1.local.log.directory.selector.dialog.title"), this);
		if ( null == directory)
			return;
	...
	private void setup_errorLogTextArea() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.xgrid1.dialog.error.log"));
		panel.add( label);
	...
	private boolean edit_experimentManager() {
		...
		if ( !Reflection.execute_class_method( _frame, "edit_experimentManager",
			...
			new Object[] { _experimentManager, ResourceManager.get( "plugin.xgrid1.dialog.title"), this},
			resultList)) {
