...
public class GridDlg extends Dialog implements INumberSpinnerHandler {
	...
	public static boolean execute(String name, File file, JFrame frame, String username, String password, String root_directory, String java_home, String home_directory, String sgeout_directory, String program_directory) {
		...
		if ( null == resultList || resultList.isEmpty()) {
			JOptionPane.showMessageDialog(
				frame,
				ResourceManager.get( "plugin.grid3.error.message.no.script"),
				ResourceManager.get( "plugin.grid3.dialog.title"),
		...
		GridLoginDlg gridLoginDlg = new GridLoginDlg(
			frame,
			ResourceManager.get( "plugin.grid3.login.dialog.title"),
			true,
			root_directory,
			parameters);
		...
		GridFrame gridFrame = new GridFrame(
			ResourceManager.get( "plugin.grid3.frame.title")
	...
	private void setup_grid_portal_ip_address_textField() {
		...
		_labels[ 0] = new JLabel( ResourceManager.get( "plugin.grid3.dialog.gird.portal.ip.address"), SwingConstants.RIGHT);
		panel.add( _labels[ 0]);
	...
	private void setup_username_textField() {
		...
		_labels[ 1] = new JLabel( ResourceManager.get( "plugin.grid3.dialog.username"), SwingConstants.RIGHT);
		panel.add( _labels[ 1]);
	...
	private void setup_script_directory_textField() {
		...
		_labels[ 2] = new JLabel( ResourceManager.get( "plugin.grid3.dialog.script.directory"), SwingConstants.RIGHT);
		panel.add( _labels[ 2]);
		...
		_script_directory_selector_button = new JButton( ResourceManager.get( "plugin.grid3.dialog.script.reference"));
	...
	protected void on_script_directory_selector_button_actionPerformed(ActionEvent actionEvent) {
		String directory = Tool.get_remote_directory( _script_directory_textField.getText(),
			ResourceManager.get( "plugin.grid3.script.directory.selector.dialog.title"),
	...
	private void setup_log_directory_textField() {
		...
		_labels[ 3] = new JLabel( ResourceManager.get( "plugin.grid3.dialog.log.directory"), SwingConstants.RIGHT);
		panel.add( _labels[ 3]);
		...
		_log_directory_selector_button = new JButton( ResourceManager.get( "plugin.grid3.dialog.log.reference"));
	...
	protected void on_log_directory_selector_button_actionPerformed(ActionEvent actionEvent) {
		String directory = Tool.get_remote_directory( _log_directory_textField.getText(),
			ResourceManager.get( "plugin.grid3.log.directory.selector.dialog.title"),
			( Frame)getOwner(), this, _parameters._grid_portal_ip_address, _parameters._username, _parameters._password,
			_root_directory, _parameters._local_username);
		if ( null == directory)
			return;
	...
	private void setup_model_builder_memory_size_numberSpinner() {
		...
		_labels[ 4] = new JLabel( ResourceManager.get( "plugin.grid3.dialog.model.builder.memory.size"), SwingConstants.RIGHT);
		panel.add( _labels[ 4]);
	...
	private void setup_simulation_checkBox() {
		...
		_simulation_checkBox = new JCheckBox(
			ResourceManager.get( "plugin.grid3.dialog.simulation"),
	...
	private void setup_number_of_times_numberSpinner() {
		...
		_labels[ 5] = new JLabel( ResourceManager.get( "plugin.grid3.dialog.number.of.times"), SwingConstants.RIGHT);
		panel.add( _labels[ 5]);
	...
	private void setup_log_analysis_checkBox() {
		...
		_log_analysis_checkBox = new JCheckBox(
			ResourceManager.get( "plugin.grid3.dialog.log.analysis"),
	...
	private void setup_log_analysis_condition_filename_textField() {
		...
		_labels[ 6] = new JLabel( ResourceManager.get( "plugin.grid3.dialog.log.analysis.condition.filename"), SwingConstants.RIGHT);
		...
		_log_analysis_condition_file_selector_button = new JButton( ResourceManager.get( "plugin.grid3.dialog.log.analysis.condition.filename.reference"));
	...
	protected void on_log_analysis_condition_file_selector_button_actionPerformed(ActionEvent actionEvent) {
		File file = Tool.get_file( _log_analysis_condition_filename_textField.getText(),
			ResourceManager.get( "plugin.grid3.log.analysis.condition.file.selector.dialog.title"),
			new String[] { "groovy"},
	...
	private void setup_transfer_log_checkBox() {
		...
		_transfer_log_checkBox = new JCheckBox(
			ResourceManager.get( "plugin.grid3.dialog.log.transfer"),
	...
	private void setup_local_log_directory_textField() {
		...
		_labels[ 7] = new JLabel( ResourceManager.get( "plugin.grid3.dialog.local.log.directory"), SwingConstants.RIGHT);
		panel.add( _labels[ 7]);
		...
		_local_log_directory_selector_button = new JButton( ResourceManager.get( "plugin.grid3.dialog.local.log.reference"));
	...
	protected void on_local_log_directory_selector_button_actionPerformed(ActionEvent actionEvent) {
		File directory = Tool.get_directory( _local_log_directory_textField.getText(),
			ResourceManager.get( "plugin.grid3.local.log.directory.selector.dialog.title"), this);
		if ( null == directory)
			return;
	...
	private void setup_error_log_textArea() {
		...
		JLabel label = new JLabel( ResourceManager.get( "plugin.grid3.dialog.error.log"));
		panel.add( label);
	...
	private boolean edit_experimentManager() {
		...
		if ( !Reflection.execute_class_method( _frame, "edit_experimentManager",
			...
			new Object[] { _experimentManager, ResourceManager.get( "plugin.grid3.dialog.title"), this},
			resultList)) {
