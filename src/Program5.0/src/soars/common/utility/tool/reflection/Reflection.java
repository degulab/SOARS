...
public class Reflection {
	 ...
	 * @return
	 */
	public static Object get_class_instance(String name, Class[] classes, Object[] arguments) {
		Class cls = null;
		try {
			cls = Class.forName( name);
		} catch (ClassNotFoundException e) {
		...
		return get_class_instance( cls, classes, arguments);
	}
	 ...
	 * @return
	 */
	public static Object get_class_instance(Class cls, Class[] classes, Object[] arguments) {
		Object object = null;
		try {
