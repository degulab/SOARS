	...
	public void execute_timer_task(int id) {
		Reflection.execute_class_method( _chartFrame, "append",
			...
			new Object[] { Integer.valueOf( 0),
				Double.valueOf( Math.PI * _count / 25),
				Double.valueOf( 50.0 + ( Math.sin( Math.PI * _count / 25)))});
		Reflection.execute_class_method( _chartFrame, "append",
			new Class[] { Integer.class, Double.class, Double.class},
			new Object[] { Integer.valueOf( 1),
				Double.valueOf( Math.PI * _count / 25),
				Double.valueOf( 50.0 + 10.0 * ( Math.cos( Math.PI * _count / 25)))});
	...
	public void start() {
		if ( null == _chartFrame) {
			...
			Reflection.execute_class_method( _chartFrame, "addLegend",
				new Class[] { Integer.class, String.class}, new Object[] { Integer.valueOf( 0), "Test0"});
			Reflection.execute_class_method( _chartFrame, "addLegend",
				new Class[] { Integer.class, String.class}, new Object[] { Integer.valueOf( 1), "Test1"});

//			Refrection.execute_class_method( _chartFrame, "setYRange",
//				new Class[] { Double.class, Double.class},
//				new Object[] { Double.valueOf( 50), Double.valueOf( 55)});
		}
