...
import soars.application.visualshell.object.arbitrary.JavaMethodCallPlugin;
...
public class PluginTable extends TableBase {
	...
	public boolean setup() {
		...
		JavaMethodCallPlugin javaMethodCallPlugin = new JavaMethodCallPlugin();
		objects[ 0] = new JCheckBox( javaMethodCallPlugin.getName(), javaMethodCallPlugin._enable);
		objects[ 1] = javaMethodCallPlugin;
		objects[ 2] = javaMethodCallPlugin;
	 ...
	 */
	public void on_ok() {
		JavaMethodCallPlugin javaMethodCallPlugin = null;
		...
		for ( int i = 0; i < defaultTableModel.getRowCount(); ++i) {
			...
			if ( plugin instanceof JavaMethodCallPlugin) {
				javaMethodCallPlugin = ( JavaMethodCallPlugin)plugin;
				continue;
			}
		...
		if ( javaMethodCallPlugin._enable == javaMethodCallPlugin._originalEnable
			&& functionalObjectPlugin._enable == functionalObjectPlugin._originalEnable
//		if ( functionalObjectPlugin._enable == functionalObjectPlugin._originalEnable
		...
		Environment.get_instance().set( Environment._enableJavaMethodCallKey, javaMethodCallPlugin._enable ? "true" : "false");
