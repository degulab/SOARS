...
public class SerialModelBuilder implements Runnable {
	 ...
	 */
	public static void execute(ScriptFile[] scriptFiles, MonitorPropertyPage monitorPropertyPage, boolean toFile, boolean keepUserDataFile) {
		SerialModelBuilder serialModelBuilder = new SerialModelBuilder( scriptFiles, monitorPropertyPage, toFile, keepUserDataFile);
	 ...
	 * @param keepUserDataFile 
	 */
	public SerialModelBuilder(ScriptFile[] scriptFiles, MonitorPropertyPage monitorPropertyPage, boolean toFile, boolean keepUserDataFile) {
		super();
	...
	public void run() {
		...
		ModelBuilder.run( _scriptFiles, _monitorPropertyPage, currentDirectory, currentDirectoryName, _toFile, _keepUserDataFile);
