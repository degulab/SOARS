			...
			radioButton.addItemListener( new ItemListener() {
				public void itemStateChanged(ItemEvent arg0) {
					if ( ItemEvent.SELECTED == arg0.getStateChange())
						on_self_selected( arg0);
					else if ( ItemEvent.DESELECTED == arg0.getStateChange())
						on_self_deselected( radioButton, arg0);
				}
			});
//			radioButton.addItemListener( new ItemListener() {
//				public void itemStateChanged(ItemEvent arg0) {
		...
		if ( null != buttonGroup) {
			...
			radioButton.addItemListener( new ItemListener() {
				public void itemStateChanged(ItemEvent arg0) {
					...
					if ( ItemEvent.SELECTED == arg0.getStateChange())
						on_agentSelector_selected( arg0);
					else if ( ItemEvent.DESELECTED == arg0.getStateChange())
						on_agentSelector_deselected( radioButton, arg0);
				}
			});
//			radioButton.addItemListener( new ItemListener() {
//				public void itemStateChanged(ItemEvent arg0) {
//					if ( ItemEvent.DESELECTED == arg0.getStateChange())
//						on_agentSelector_deselected();
//						//on_method_deselected( ( String)arg0.getItem());
//				}
//			});
			_radioButtons.add( radioButton);
		...
		if ( null != buttonGroup) {
			...
			radioButton.addItemListener( new ItemListener() {
				public void itemStateChanged(ItemEvent arg0) {
					...
					if ( ItemEvent.SELECTED == arg0.getStateChange())
						on_spotSelector_selected( arg0);
					else if ( ItemEvent.DESELECTED == arg0.getStateChange())
						on_spotSelector_deselected( radioButton, arg0);
				}
			});
//			radioButton.addItemListener( new ItemListener() {
//				public void itemStateChanged(ItemEvent arg0) {
//					if ( ItemEvent.DESELECTED == arg0.getStateChange())
//						on_spotSelector_deselected();
//						//on_method_deselected( ( String)arg0.getItem());
//				}
//			});
			_radioButtons.add( radioButton);
	...
	private void setup_currentSpot(List<String> entities, ButtonGroup buttonGroup, JPanel parent) {
		...
		if ( null != buttonGroup) {
			...
			radioButton.addItemListener( new ItemListener() {
				public void itemStateChanged(ItemEvent arg0) {
					if ( ItemEvent.SELECTED == arg0.getStateChange())
						on_currentSpot_selected( arg0);
					else if ( ItemEvent.DESELECTED == arg0.getStateChange())
						on_currentSpot_deselected( radioButton, arg0);
				}
			});
//			radioButton.addItemListener( new ItemListener() {
//				public void itemStateChanged(ItemEvent arg0) {
//					if ( ItemEvent.DESELECTED == arg0.getStateChange())
//						on_currentSpot_deselected();
//						//on_method_deselected( ( String)arg0.getItem());
//				}
//			});
			_radioButtons.add( radioButton);
	...
	private void setup_agentVariableComboBox(List<String> entityVariables, JPanel parent) {
		...
		_agentVariableCheckBox.addItemListener( new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				before_agentVariableCheckBox_state_changed( arg0);
				...
				update();
				after_agentVariableCheckBox_state_changed( arg0);
			}
		});
		...
		_agentVariableComboBox.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				on_agentVariableComboBox_selected( arg0);
			}
		});
		_agentVariableComboBox.addItemListener( new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				if ( ItemEvent.DESELECTED != arg0.getStateChange())
					return;

				on_agentVariableComboBox_deselected( arg0);
			}
		});
		gridBagConstraints.fill = GridBagConstraints.HORIZONTAL;
		gridBagConstraints.weightx = 1.0;
	...
	private void setup_spotVariableComboBox(List<String> entityVariables, JPanel parent) {
		...
		_spotVariableCheckBox.addItemListener( new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				before_spotVariableCheckBox_state_changed( arg0);
				...
				update();
				after_spotVariableCheckBox_state_changed( arg0);
			}
		});
		...
		_spotVariableComboBox.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				on_spotVariableComboBox_selected( arg0);
			}
		});
		_spotVariableComboBox.addItemListener( new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				if ( ItemEvent.DESELECTED != arg0.getStateChange())
					return;

				on_spotVariableComboBox_deselected( arg0);
			}
		});
		gridBagConstraints.fill = GridBagConstraints.HORIZONTAL;
		gridBagConstraints.weightx = 1.0;
	...
	protected void setup_variables_panel(List<Variable> variables, JPanel parent) {
		...
		// TODO For java method call
		on_setup_variables_panel( variables, northPanel);
	...
	private void setup_variable_type_panel(JPanel parent) {
		...
		_variableTypeComboBox.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				on_variableTypeComboBox_selected( arg0);
				update_variable_panel();
			}
		});
		_variableTypeComboBox.addItemListener( new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				if ( ItemEvent.DESELECTED != arg0.getStateChange())
					return;

				on_variableTypeComboBox_deselected( arg0);
			}
		});
	 ...
	 * @return
	 */
	protected Variable get_selected_variable() {
		String variableTypeName = ( String)_variableTypeComboBox.getSelectedItem();
		if ( null == variableTypeName)
			return null;
		...
		for ( Variable variable:variables) {
			if ( variable._name.equals( variableTypeName))
				return variable;
		}
	 ...
	 * @return
	 */
	protected Variable get_variable_by_type(String variableType) {
		Vector<Variable> variables = get_variables();
		if ( null == variables)
			return null;

		for ( Variable variable:variables) {
			if ( variable._type.equals( variableType))
				return variable;
		}
	 ...
	 * @return
	 */
	protected Variable get_variable_by_typename(String variableTypeName) {
		Vector<Variable> variables = get_variables();
		if ( null == variables)
			return null;
		...
		if ( Constant.contains( variable._type)
			...
			comboBox.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					on_variableComboBox_selected( comboBox, arg0);
				}
			});
			comboBox.addItemListener( new ItemListener() {
				public void itemStateChanged(ItemEvent arg0) {
					...
					on_variableComboBox_deselected( comboBox, arg0);
				}
			});
			panel.add( comboBox);
	...
	public void changed(String name, String number, String fullName, ObjectSelector objectSelector) {
		if ( objectSelector == _agentSelector) {
			before_agentSelector_changed();
			on_agentSelector_selected();
			after_agentSelector_changed();
		} else if ( objectSelector == _spotSelector) {
			before_spotSelector_changed();
			on_spotSelector_selected();
			after_spotSelector_changed();
		}
	}
	...
	public boolean get(EntityVariableRule entityVariableRule, boolean check) {
		if ( null == entityVariableRule._entity)
			return false;
		...
		if ( entityVariableRule._entity.equals( "agent")) {
			...
			String entityName = _agentSelector.get_exactly();
			...
			String entityName = _spotSelector.get_exactly();
			if ( null == entityName || ( check && entityName.equals( "")))
				return false;
