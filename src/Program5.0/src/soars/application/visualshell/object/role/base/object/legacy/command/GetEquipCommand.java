...
public class GetEquipCommand extends EquipCommand {
	 ...
	 * 
	 */
	public static String _reservedWord = "getEquip ";
	...
	private static int get_kind(String value, ILayerManipulator layerManipulator) {
		...
		if ( !reservedWord.equals( _reservedWord))
			return -1;
	...
	public boolean update_spot_name_and_number(String newName, String originalName, String headName, Vector<String[]> ranges, String newHeadName, Vector<String[]> newRanges) {
		...
		elements[ 1] = CommonRuleManipulator.update_spot_name2( elements[ 1], newName, originalName, headName, ranges, newHeadName, newRanges);
		if ( null == elements[ 1])
			return false;
	...
	protected boolean update_spot_variable_name(String name, String newName, String type, Role role) {
		...
		elements[ 1] = CommonRuleManipulator.update_spot_variable_name2( elements[ 1], name, newName, type);
		if ( null == elements[ 1])
			return result1;
	...
	protected String get_script(String value, Role role) {
		...
		return get_script( prefixAndObject2[ 0], elements1[ 0], prefixAndObject1[ 1],
			prefixAndObject2[ 1], ( prefixAndObject1[ 0].equals( "") ? "" : "<>"), keyword, timeVariable, spotVariable);
	}
}
