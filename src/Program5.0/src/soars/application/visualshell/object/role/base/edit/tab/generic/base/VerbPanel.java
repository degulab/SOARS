...
import soars.application.visualshell.object.role.base.edit.tab.generic.common.java_method_call.JavaMethodCallPanel;
...
//			return false;
	 ...
	 * @param show
	 */
	public void show_denial_panel(boolean show) {
	}
	...
	private boolean setup_verbObjectPanelMap(Verb verb, Role role, Map<String, List<PanelRoot>> buddiesMap, JPanel parent) {
		...
		for ( Subject object:verb._objects) {
			...
			else if ( object._javaMethodCall)
				panelRoot = new JavaMethodCallPanel( object, this, _property, role, buddiesMap, _genericPropertyPanel, _owner, parent);
			else
