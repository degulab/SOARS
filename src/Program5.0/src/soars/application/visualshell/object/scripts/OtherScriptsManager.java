...
public class OtherScriptsManager {
	 ...
	 * @return
	 */
	public String get_script(String scriptDirectory, String programDirectory, boolean userLogFile, boolean monitor, boolean grid, boolean ga) {
		String script = "";
		...
		// TODO for monitor
		if ( monitor)
			script += ( "file:" + Constant._monitorJar + Constant._lineSeparator);
...
//					line += ( ( programDirectory.equals( "") ? "" : ( programDirectory + "/")) + jarFilenames[ i] + Constant._lineSeparator);
		...
		script += "file:"
			+ ( programDirectory.equals( "") ? "" : ( programDirectory + "/"))
			+ Constant._javaMethodCallJar + Constant._lineSeparator;
...
//				script += ( lines[ i] + Constant._lineSeparator);
		...
		if ( userLogFile) {
			script += ( "file:" + Constant._userLogFileJar + Constant._lineSeparator);
			for ( String jacksonJarFileName:Constant._jacksonJarFileNames)
				script += ( "file:" + jacksonJarFileName + Constant._lineSeparator);
		}
