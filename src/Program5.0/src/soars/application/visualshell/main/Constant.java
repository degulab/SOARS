...
public class Constant extends CommonConstant {
	 ...
	 */
	static public final String _applicationVersion = "20200319";
	 ...
	 */
	static public final String _javaMethodCallJar = "../library/java_method_call/javamethodcall.jar";

	/**
	 * Java method call spot name.
	 */
	static public final String _javaMethodCallSpotName = "__javaMethodCallSpot";

	/**
	 * Java method call class variable name.
	 */
	static public final String _javaMethodCallClassVariableName = "__javaMethodCallReflection";

	/**
	 * Java method call class name.
	 */
	static public final String _javaMethodCallClassName = "soars.library.adapter.java_method_call.JavaMethodCall";

	/**
	 * Java method call condition method name.
	 */
	static public final String _javaMethodCallConditionMethodName = "execute_condition";

	/**
	 * Java method call command method name.
	 */
	static public final String _javaMethodCallCommandMethodName = "execute_command";

	/**
	 * Java method call parameters variable name.
	 */
	static public final String _javaMethodCallParameterListName = "__javaMethodCallParameterList";
	...
	static public final String[] _exchangeAlgebraJar = {
		...
		"../library/exalge/exchangealgebra.jar",
	 ...
	 */
	static public final String _userRuleArgumentListName = "__userRuleList";

	/**
	 * Name of initial stage for user log spot.
	 */
	static public final String _userLogFileInitialStageName = "__userLogFileInitialStage";

	/**
	 * Name of main stage for user log spot.
	 */
	static public final String _userLogFileMainStageName = "__userLogFileMainStage";

	/**
	 * Name of terminal stage for user log spot.
	 */
	static public final String _userLogFileTerminalStageName = "__userLogFileTerminalStage";

	/**
	 * User log spot name.
	 */
	static public final String _userLogFileSpotName = "__userLogFileSpot";

	/**
	 * Name of role for user log spot.
	 */
	static public final String _userLogFileRoleName = "__userLogFileRole";

	/**
	 * SOARS classURL script for logger.jar.
	 */
	static public final String _userLogFileJar = "../library/logger/logger.jar";

	/**
	 * User log class variable name.
	 */
	static public final String _userLogFileClassVariableName = "__logger";

	/**
	 * User log class name.
	 */
	static public final String _userLogFileClassName = "soars.library.arbitrary.logger.Logger";

	/**
	 * User log start command method name.
	 */
	static public final String _userLogFileStartMethodName = "start";

	/**
	 * User log start command parameter keyword name.
	 */
	static public final String _userLogFileStartMethodParameterKeywordName = "__logFolderPath";

	/**
	 * User log execute command method name.
	 */
	static public final String _userLogFileExecuteMethodName = "execute";

	/**
	 * User log terminate command method name.
	 */
	static public final String _userLogFileTerminateMethodName = "terminate";

	/**
	 * Name of initial stage for monitor spot.
	 */
	static public final String _monitorInitialStageName = "__monitorInitialStage";

	/**
	 * Name of main stage for monitor spot.
	 */
	static public final String _monitorMainStageName = "__monitorMainStage";

	/**
	 * Name of terminal stage for monitor spot.
	 */
	static public final String _monitorTerminalStageName = "__monitorTerminalStage";

	/**
	 * Monitor spot name.
	 */
	static public final String _monitorSpotName = "__monitorSpot";

	/**
	 * Name of role for monitor spot.
	 */
	static public final String _monitorRoleName = "__monitorRole";

	/**
	 * SOARS classURL script for monitor.jar.
	 */
	static public final String _monitorJar = "../library/monitor/monitor.jar";

	/**
	 * Monitor class variable name.
	 */
	static public final String _monitorClassVariableName = "__monitor";

	/**
	 * Monitor class name.
	 */
	static public final String _monitorClassName = "soars.library.arbitrary.monitor.Monitor";

	/**
	 * Monitor command method name.
	 */
	static public final String _monitorMethodName = "print";

	/**
	 * Monitor command parameter keyword name.
	 */
	static public final String _monitorMethodParameterKeywordName = "__terminalTime";

	/**
	 * Names of jackson jar files.
	 */
	static public final String[] _jacksonJarFileNames = new String[] {
		"../library/jackson/jackson-core-2.9.8.jar",
		"../library/jackson/jackson-databind-2.9.8.jar",
		"../library/jackson/jackson-annotations-2.9.8.jar"
	};
	...
	public static boolean is_correct_agent_or_spot_name(String name) {
		return ( !name.equals( "")
			...
			&& !name.equals( _userRuleArgumentListName)
