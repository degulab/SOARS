...
public class SaxLoader extends DefaultHandler {
	 ...
	 */
	// TODO 2019.12.18
	private JavaMethodCallRule _javaMethodCallRule = null;;
	...
	public void startElement( String arg0, String arg1, String arg2, Attributes arg3) throws SAXException {
		...
		if ( arg2.equals( "stage")) {
			...
			on_expression( arg3);
		} else if ( arg2.equals( "javamethodcall")) {
			on_java_method_call( arg3);
	...
	private void on_class_variable(Attributes attributes, String type) {
		...
		if ( Environment.get_instance().is_java_method_call_enable() || Environment.get_instance().is_functional_object_enable()) {
	...
	private void on_genericRule_entityVariable(Attributes attributes, String name) {
		...
		if ( null != _expressionRule)
		...
		else if ( null != _javaMethodCallRule) {
			// Javaメソッド呼出内変数の場合
			...
			_javaMethodCallRule.set( kind, new EntityVariableRule( entity, entityName, agentVariable, spotVariable, variableType, variableValue));
		} else {
			// エンティティ変数の場合
	 ...
	 * @param attributes
	 */
	private void on_java_method_call(Attributes attributes) {
		// TODO 2019.12.18
		if ( null == _genericRule) {
			_result = false;
			return;
		...
		_javaMethodCallRule = new JavaMethodCallRule( _genericRule._kind, method);
		_genericRule._objects.add( _javaMethodCallRule);
	}
	 ...
	 * 
	 */
	private void on_java_method_call() {
		// TODO 2019.12.18
		if ( null != _genericRule)
			// GenericRulleのJavaメソッド呼出
			_javaMethodCallRule = null;
	}
