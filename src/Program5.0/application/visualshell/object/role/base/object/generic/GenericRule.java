...
public class GenericRule extends RuleNew {
	...
	private IObject create(IObject object) {
		...
		else if ( object instanceof JavaMethodCallRule)
			return new JavaMethodCallRule( ( JavaMethodCallRule)object);
		return null;
	}
	...
	public String get_script(int row, InitialValueMap initialValueMap, boolean demo, Role role) {
		...
		if ( _system && !get_method( role).contains( ":")) {
			// TODO 2019.8 For Exchange algebra
			if ( _type.equals( "javamethodcall")) {
				// TODO 2020.1.11 For Java method call
				String text = "<" + Constant._javaMethodCallSpotName + ">setEquip " + Constant._javaMethodCallParameterListName + "=java.util.LinkedList" + get_separator();
				text += "<" + Constant._javaMethodCallSpotName + ">logEquip " + Constant._javaMethodCallParameterListName + get_separator();
				text += "<" + Constant._javaMethodCallSpotName + ">" + ( ( role instanceof AgentRole) ? "addLastAgent" : "addLastSpot") + " " + Constant._javaMethodCallParameterListName + get_separator();
				text += "<" + Constant._javaMethodCallSpotName + ">addLastString " + Constant._javaMethodCallParameterListName + "=" + get_method( role) + get_separator();
				text += "<" + Constant._javaMethodCallSpotName + ">addLastString " + Constant._javaMethodCallParameterListName + "=" + _subject.get_script( initialValueMap, role, true) + get_separator();
				text += _objects.get( 0).get_script( initialValueMap, _subject, role);
				text += "<" + Constant._javaMethodCallSpotName + ">addParam " + Constant._javaMethodCallClassVariableName + "=" + Constant._javaMethodCallParameterListName + "=java.util.LinkedList" + get_separator();
				text += ( _denial ? "!" : "") + "<" + Constant._javaMethodCallSpotName + ">invokeClass " + Constant._javaMethodCallClassVariableName + "=";

				if ( _kind.equals( "condition"))
					text += Constant._javaMethodCallConditionMethodName;
				else if ( _kind.equals( "command"))
					text += Constant._javaMethodCallCommandMethodName;
			...
			// TODO For User rule GUI
			String text = "<" + Constant._userRuleSpotName + ">setEquip " + Constant._userRuleArgumentListName + "=java.util.LinkedList" + get_separator();
			text += "<" + Constant._userRuleSpotName + ">logEquip " + Constant._userRuleArgumentListName + get_separator();
			text += "<" + Constant._userRuleSpotName + ">" + ( ( role instanceof AgentRole) ? "addLastAgent" : "addLastSpot") + " " + Constant._userRuleArgumentListName + get_separator();
			text += "<" + Constant._userRuleSpotName + ">addLastString " + Constant._userRuleArgumentListName + "=" + get_method( role) + get_separator();
			text += "<" + Constant._userRuleSpotName + ">addLastString " + Constant._userRuleArgumentListName + "=" + _subject.get_script( initialValueMap, role, true) + get_separator();
			for ( IObject object:_objects)
				text += "<" + Constant._userRuleSpotName + ">addLastString " + Constant._userRuleArgumentListName + "=" + object.get_script( initialValueMap, _subject, role) + get_separator();

			text += "<" + Constant._userRuleSpotName + ">addParam " + Constant._userRuleClassVariableName + "=" + Constant._userRuleArgumentListName + "=java.util.LinkedList" + get_separator();
