...
public class EditExperimentForModelBuilderDlg extends EditExperimentDlgBase1 {
	...
	protected void on_setup_south_panel(JPanel parent) {
		...
		setup_user_log_file_checkBox( Environment.get_instance().get( Environment._editExportSettingDialogUserLogFileKey, "false").equals( "true"), panel);
	 ...
	 * @param parent
	 */
	private void setup_user_log_file_checkBox(boolean selected, JPanel parent) {
		...
		_userLogFileCheckBox.setSelected( selected);
		parent.add( _userLogFileCheckBox);
	}
