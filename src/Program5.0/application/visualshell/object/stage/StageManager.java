...
public class StageManager {
	 ...
	 * @return
	 */
	public String get_script(boolean userLogFile, boolean monitor, boolean grid, boolean ga) {
		// TODO
		if ( _mainStages.isEmpty() && _initialStages.isEmpty() && _terminalStages.isEmpty()
		...
		// TODO for monitor
		String script1 = !monitor ? "" : ( Constant._monitorInitialStageName + Constant._lineSeparator);

		script1 += ( LayerManager.get_instance().initial_data_file_exists() ? ( Constant._initialDataFileStageName + Constant._lineSeparator) : "");
		for ( Stage stage:_initialStages) {
		...
		script1 += !userLogFile ? "" : ( Constant._userLogFileInitialStageName + Constant._lineSeparator);

		// TODO for monitor
		String script2 = !monitor ? "" : ( Constant._monitorMainStageName + Constant._lineSeparator);
		...
		// TODO for user log file
		script2 += !userLogFile ? "" : ( Constant._userLogFileMainStageName + Constant._lineSeparator);

		// TODO for monitor
		String script3 = !monitor ? "" : ( Constant._monitorTerminalStageName + Constant._lineSeparator);
		...
		// TODO for user log file
		script3 += !userLogFile ? "" : ( Constant._userLogFileTerminalStageName + Constant._lineSeparator);
