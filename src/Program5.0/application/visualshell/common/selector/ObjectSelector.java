...
public class ObjectSelector extends JPanel implements INumberSpinnerHandler {
	...
	/**
	 * Returns the selected name of the object exactly.
	 * @return the selected name of the object exactly
	 */
	public String get_exactly() {
		String name = ( String)_objectNameComboBox.getSelectedItem();
		if ( null == name || name.equals( ""))
			return "";
		...
		return entityBase._number.equals( "") ? name : ( name + String.valueOf( _numberSpinner.get_value()));
	}
