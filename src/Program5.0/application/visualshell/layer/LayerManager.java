...
//	}
	 ...
	 * @param entityName the entity full name
	 * @param classVariableName the specified name
	 * @return the class variable whose name is equal to the specified one
	 */
	public ClassVariableObject get_class_variable(String entityType, String entityName, String classVariableName) {
		// TODO Auto-generated method stub
		for ( Layer layer:this) {
			ClassVariableObject classVariableObject = layer.get_class_variable( entityType, entityName, classVariableName);
			if ( null != classVariableObject)
				return classVariableObject;
		}
		return null;
...
//	}
	...
	public boolean export_data(File file, boolean toDisplay, boolean toFile) {
		if ( !ExperimentManager.get_instance().isEmpty()) {
			...
			return Exporter.execute_on_model_builder( file, null, null, "", toDisplay, toFile, false, false, false);
	}
	 ...
	 */
	public ScriptFile[] export_data(/*boolean animator, */boolean toDisplay, boolean toFile, boolean userLogFile, boolean monitor) {
...
//		if ( !animator) {
			...
			if ( !Exporter.execute_on_model_builder( scriptFiles[ 0]._path, null, workDirectoryName, "", toDisplay, toFile, userLogFile, monitor, false)) {
...
//		}
	 ...
	 * @param entities
	 */
	public void get_entities_have_this_object(String type, String name, List<String> entities) {
		// TODO Auto-generated method stub
		for ( Layer layer:this)
			layer.get_entities_have_this_object( type, name, entities);
	}
	 ...
	 * @return the ModelBuilder scripts 
	 */
	public ScriptFile[] export_data(/*boolean animator, */boolean toDisplay, boolean toFile, boolean userLogFile, boolean monitor, ExperimentManager experimentManager) {
		if ( 0 == experimentManager.get_initial_value_count())
			return null;
		else
			return experimentManager.export( /*animator, */toDisplay, toFile, userLogFile, monitor);
	}
