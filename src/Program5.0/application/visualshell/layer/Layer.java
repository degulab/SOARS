...
//		return false;
	...
	public ClassVariableObject get_class_variable(String entityType, String entityName, String classVariableName) {
		...
		for ( DrawObject drawObject:this) {
			if ( entityType.equals( "agent") || entityType.equals( "self")) {
				if ( !( drawObject instanceof AgentObject))
					continue;
				...
				if ( entityName.equals( "")) {
					...
					if ( !agentObject.has_same_name( entityName))
						continue;
			...
			} else if ( entityType.equals( "spot") || entityType.equals( "currentspot")) {
				if ( !( drawObject instanceof SpotObject))
					continue;
				...
				if ( entityName.equals( "")) {
					...
					if ( !spotObject.has_same_name( entityName))
						continue;
...
//	}
	...
	public void get_entities_have_this_object(String type, String name, List<String> entities) {
		...
		for ( DrawObject drawObject:this) {
			if ( ( type.equals( "agent") && ( drawObject instanceof AgentObject))
				|| ( type.equals( "spot") && ( drawObject instanceof SpotObject))) {
				if ( !entities.contains( drawObject._name) && drawObject.has_this_object( name))
					entities.add( drawObject._name);
			}
		}
	}
