...
public class Environment extends EnvironmentBase {
	 ...
	 * 
	 */
	static public final String _editExportSettingDialogUserLogFileKey = "Edit.export.setting.dialog.user.log.file";
	...
	/**
	 * Key mapped to the flag which indicates whether to enable the java method call.
	 */
	static public final String _enableJavaMethodCallKey = "Enable.java.method.call";
	...
	/**
	 * Key mapped to the default flag which indicates whether to enable the java method call.
	 */
	static public final String _enableJavaMethodCallDefaultValue = "false";

	/**
	 * 
	 */
	private boolean _enableJavaMethodCall = _enableJavaMethodCallDefaultValue.equals( "true");

	/**
	 * Key mapped to the default flag which indicates whether to enable the functional objects.
	 */
	static public final String _enableFunctionalObjectDefaultValue = "false";
	...
	public boolean initialize() throws FileNotFoundException, IOException {
		...
		_enableJavaMethodCall = get( _enableJavaMethodCallKey, _enableJavaMethodCallDefaultValue).equals( "true");
	...
	/**
	 * Returns whether or not the java method call is enabled.
	 * @return whether or not the java method call is enabled
	 */
	public boolean is_java_method_call_enable() {
		// TODO Auto-generated method stub
		return _enableJavaMethodCall;
	}

	/**
	 * Enables the java method call.
	 */
	public void enable_java_method_call() {
		// TODO Auto-generated method stub
		set( _enableJavaMethodCallKey, "true");
		_enableJavaMethodCall = true;
	}
