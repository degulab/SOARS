 ...
 * 
 */
public class TMiddleMoveRoleMove5Rule extends TAgentRule {

	/** ルール名 */
	public static String RULE_NAME = "MiddleMoveRoleMove5";
	 ...
	 * @param ownerRole
	 */
	public TMiddleMoveRoleMove5Rule(TRole ownerRole) {
	...
	private boolean method1(TTime currentTime, String currentStage, HashMap<String, TSpot> spotSet,
		...
		if (ownerRole.getADS().equals("3")
			// && condition : probability : <model>askEquip piso3=
			&& getRandom().nextDouble()<=modelRole.getpiso3()) {
