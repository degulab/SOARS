 ...
 * 
 */
public class TMiddleMoveRoleMove7Rule extends TAgentRule {

	/** ルール名 */
	public static String RULE_NAME = "MiddleMoveRoleMove7";
	 ...
	 * @param ownerRole
	 */
	public TMiddleMoveRoleMove7Rule(TRole ownerRole) {
	...
	private boolean method1(TTime currentTime, String currentStage, HashMap<String, TSpot> spotSet,
		...
		// condition : keyword : <model>is officeclose=yes
		if (modelRole.getofficeclose().equals("yes")) {
			return true;
		}
		return false;
	}
