 ...
 * 
 */
public class TMiddleMoveRoleMove2Rule extends TAgentRule {

	/** ルール名 */
	public static String RULE_NAME = "MiddleMoveRoleMove2";
	 ...
	 * @param ownerRole
	 */
	public TMiddleMoveRoleMove2Rule(TRole ownerRole) {
