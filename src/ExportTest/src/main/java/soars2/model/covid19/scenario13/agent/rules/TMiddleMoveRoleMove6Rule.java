 ...
 * 
 */
public class TMiddleMoveRoleMove6Rule extends TAgentRule {

	/** ルール名 */
	public static String RULE_NAME = "MiddleMoveRoleMove6";
	 ...
	 * @param ownerRole
	 */
	public TMiddleMoveRoleMove6Rule(TRole ownerRole) {
