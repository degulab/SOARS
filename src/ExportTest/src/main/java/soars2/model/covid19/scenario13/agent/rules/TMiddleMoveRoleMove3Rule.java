 ...
 * 
 */
public class TMiddleMoveRoleMove3Rule extends TAgentRule {

	/** ルール名 */
	public static String RULE_NAME = "MiddleMoveRoleMove3";
	 ...
	 * @param ownerRole
	 */
	public TMiddleMoveRoleMove3Rule(TRole ownerRole) {
