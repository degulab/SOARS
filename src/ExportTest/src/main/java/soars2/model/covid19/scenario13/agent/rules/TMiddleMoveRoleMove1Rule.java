 ...
 * 
 */
public class TMiddleMoveRoleMove1Rule extends TAgentRule {

	/** ルール名 */
	public static String RULE_NAME = "MiddleMoveRoleMove1";
	 ...
	 * @param ownerRole
	 */
	public TMiddleMoveRoleMove1Rule(TRole ownerRole) {
	...
	private boolean method1(TTime currentTime, String currentStage, HashMap<String, TSpot> spotSet,
		...
		if (ownerRole.getADS().equals("D")) {
			// command : move : <DEAD>moveTo
			getAgent().moveTo(TSpotTypes.DEAD, spotSet);
			return true;
		}
		return false;
	}
